    ...
    const e = (e) => Math.abs(parseInt(e, 10)),
        ...
        a = (e, a) => {
            ...
            if (((e.wpcf7.status = a), e.setAttribute("data-status", a), e.classList.add(a), r && r !== a)) {
                ...
                const a = { contactFormId: e.wpcf7.id, pluginVersion: e.wpcf7.pluginVersion, contactFormLocale: e.wpcf7.locale, unitTag: e.wpcf7.unitTag, containerPostId: e.wpcf7.containerPost, status: e.wpcf7.status, prevStatus: r };
                t(e, "statuschanged", a);
            }
            return a;
        },
    ...
    function o(e, t = {}) {
        ...
        for (const e of o.querySelectorAll(".wpcf7-form-control-wrap"))
            if (
                ...
                e.dataset.name && (u.push(e.dataset.name), e.setAttribute("data-under-validation", "1"), e.contains(r)))
            )
                break;
        ...
        Promise.resolve(a(e, "validating"))
            .then((a) => {
                if (void 0 !== swv) {
                    ...
                    for (const [t, { error: n, validInputs: r }] of a) s(e, t), void 0 !== n && c(e, t, n, { scope: o }), i(e, t, null != r ? r : []);
                }
            })
            .finally(() => {
                a(e, f),
