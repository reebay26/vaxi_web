(() => {
    ...
    (() => {
        ...
        var o = {};
        r.r(o), r.d(o, { getCollection: () => Na, getCollectionError: () => xa, getCollectionHeader: () => La, getCollectionLastModified: () => Ya });
        var c = {};
        r.r(c), r.d(c, { receiveCollection: () => Ha, receiveCollectionError: () => Va, receiveLastModified: () => qa });
        var l = {};
        ...
        var p = {};
        r.r(p), r.d(p, { getValueForQueryContext: () => ii, getValueForQueryKey: () => si });
        var _ = {};
        ...
        var E = {};
        r.r(E), r.d(E, { registerContainer: () => Ti, unregisterContainer: () => Ai });
        var g = {};
        ...
        var f = {};
        r.r(f), r.d(f, { getValidationError: () => Bi, getValidationErrorId: () => Fi, hasValidationErrors: () => $i });
        const v = window.wp.notices,
            T = window.wp.data,
            A = window.wp.dataControls,
            P = window.wp.i18n,
            b = "wc/store/cart",
            R = { code: "cart_api_error", message: (0, P.__)("Unable to get cart data from the API.", "woocommerce"), data: { status: 500 } },
        ...
        const q = {
                ...
                metaData: { updatingCustomerData: !1, updatingSelectedRate: !1, applyingCoupon: "", removingCoupon: "", isCartDataStale: !1 },
                errors: N,
            },
            B = (e) => e.cartData,
            F = (e) => ({ shippingAddress: e.cartData.shippingAddress, billingAddress: e.cartData.billingAddress }),
        ...
        const ye = (e) =>
                ((e, t) => Object.entries(e).reduce((e, [r, a]) => ({ ...e, [t(0, r)]: a }), {}))(e, (e, t) => {
                    return (
                        void 0 === r && (r = {}),
                        (function (e, t) {
                            return (
        ...
        var Me = r.n(Oe),
            ...
            Ne = r.n(ke);
        const xe = {},
            Le = { code: "invalid_json", message: (0, P.__)("The response is not a valid JSON response.", "woocommerce") },
            Ye = (e) => {
            ...
            Ue = new (Ne())(
                (e) =>
                    Me()({ path: "/wc/store/v1/batch", method: "POST", data: { requests: e.map((e) => ({ ...e, body: null == e ? void 0 : e.data })) } }).then(
                        (t) => (
                            (function (e) {
                        ...
                        ? (async (e) => await Ue.load(e))(e)
                              .then((e) => {
                                  throw (
                                      ...
                                      e.status >= 200 && e.status < 300 && (t({ response: e.body, headers: e.headers }), Ye(e.headers)),
                                      e)
                                  );
                              })
                              .catch((e) => {
        ...
        const $e = (e) => Be(e) && Fe(e, "code") && Fe(e, "message"),
            ...
            Ke = (e, t, r) => {
                ...
                (0, T.select)("wc/store/payment").isExpressPaymentMethodActive() || void 0 === a || (0, T.dispatch)("core/notices").createNotice(e, t, { isDismissible: !0, ...r, context: a });
            },
            Xe = window.wp.htmlEntities,
            Qe = (e) => ({ dispatch: t, select: r }) => {
                const a = ye(e),
                    s = r.getCartData();
                ((e = null, t = null) => {
                    t &&
                        ...
                        null !== e &&
                            e.forEach((e) => {
                                $e(e) && Ke("error", (0, Xe.decodeEntities)(e.message), { id: e.code, context: "wc/cart", isDismissible: !1 });
                            });
                })(a.errors, s.errors),
                    (({ oldCart: e, newCart: t, cartItemsPendingQuantity: r = [], cartItemsPendingDelete: a = [] }) => {
                                ...
                                e.items.forEach((e) => {
                                    r.includes(e.key) ||
                                        ...
                                        (0, T.dispatch)("core/notices").createInfoNotice(
                                            (0, P.sprintf) /* translators: %s is the name of the item. */(/* translators: %s is the name of the item. */ (0, P.__)('"%s" was removed from your cart.', "woocommerce"), e.name),
                            ...
                            ((e, t) => {
                                t.items.forEach((t) => {
                                    ...
                                    (s || i || n) &&
                                        (n
                                            ? (0, T.dispatch)("core/notices").createInfoNotice(
                                                  (0, P.sprintf) /* translators: %1$s is the name of the item, %2$d is the quantity of the item. %3$d is a number that the quantity must be a multiple of. */(
                                                      /* translators: %1$s is the name of the item, %2$d is the quantity of the item. %3$d is a number that the quantity must be a multiple of. */
                                                      (0, P.__)('The quantity of "%1$s" was changed to %2$d. You must purchase this product in groups of %3$d.', "woocommerce"),
                                                      t.name,
                                                      Math.floor(t.quantity / t.quantity_limits.multiple_of) * t.quantity_limits.multiple_of,
                                                      t.quantity_limits.multiple_of
                                                  ),
                                                  { context: "wc/cart", speak: !0, type: "snackbar", id: `${t.key}-quantity-update` }
                                              )
                                            : i
                                            ? (0, T.dispatch)("core/notices").createInfoNotice(
                                                  (0, P.sprintf) /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */(
                                                      /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */
                                                      (0, P.__)('The quantity of "%1$s" was increased to %2$d. This is the minimum required quantity.', "woocommerce"),
                                                      t.name,
                                            ...
                                            : (0, T.dispatch)("core/notices").createInfoNotice(
                                                  (0, P.sprintf) /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */(
                                                      /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */
                                                      (0, P.__)('The quantity of "%1$s" was decreased to %2$d. This is the maximum allowed quantity.', "woocommerce"),
                                                      t.name,
                    ...
                    })({ oldCart: s, newCart: a, cartItemsPendingQuantity: r.getItemsPendingQuantityUpdate(), cartItemsPendingDelete: r.getItemsPendingDelete() }),
                    t.setCartData(a);
            },
            We = (e = null) => ({ dispatch: t }) => {
                var r, a;
            ...
            lt = (e) => async ({ dispatch: t }) => {
                try {
                    const { response: r } = await Ve({ path: "/wc/store/v1/cart/extensions", method: "POST", data: { namespace: e.namespace, data: e.data }, cache: "no-store" });
                    return t.receiveCart(r), r;
                } catch (e) {
                    return t.receiveError(e), Promise.reject(e);
                }
            },
            dt = (e) => async ({ dispatch: t }) => {
                try {
                    t.receiveApplyingCoupon(e);
                    const { response: r } = await Ve({ path: "/wc/store/v1/cart/apply-coupon", method: "POST", data: { code: e }, cache: "no-store" });
                    return t.receiveCart(r), r;
                } catch (e) {
                    return t.receiveError(e), Promise.reject(e);
                } finally {
            ...
            ut = (e) => async ({ dispatch: t }) => {
                try {
                    t.receiveRemovingCoupon(e);
                    const { response: r } = await Ve({ path: "/wc/store/v1/cart/remove-coupon", method: "POST", data: { code: e }, cache: "no-store" });
                    return t.receiveCart(r), r;
                } catch (e) {
                    return t.receiveError(e), Promise.reject(e);
                } finally {
            ...
            pt = (e, t = 1) => async ({ dispatch: r }) => {
                try {
                    ge("wc-blocks_adding_to_cart", { bubbles: !0, cancelable: !0 });
                    const { response: a } = await Ve({ path: "/wc/store/v1/cart/add-item", method: "POST", data: { id: e, quantity: t }, cache: "no-store" });
                    return (
                        r.receiveCart(a),
                        (({ preserveCartData: e = !1 }) => {
                            ge("wc-blocks_added_to_cart", { bubbles: !0, cancelable: !0, detail: { preserveCartData: e } });
                        })({ preserveCartData: !0 }),
                        a
                    );
                } catch (e) {
            ...
            _t = (e) => async ({ dispatch: t }) => {
                try {
                    t.itemIsPendingDelete(e);
                    const { response: r } = await Ve({ path: "/wc/store/v1/cart/remove-item", data: { key: e }, method: "POST", cache: "no-store" });
                    return t.receiveCart(r), r;
                } catch (e) {
                    return t.receiveError(e), Promise.reject(e);
                } finally {
            ...
            mt = (e, t) => async ({ dispatch: r, select: a }) => {
                const s = a.getCartItem(e);
                if ((null == s ? void 0 : s.quantity) !== t)
                    try {
                        r.itemIsPendingQuantity(e);
                        const { response: a } = await Ve({ path: "/wc/store/v1/cart/update-item", method: "POST", data: { key: e, quantity: t }, cache: "no-store" });
            ...
            ht = (e, t = null) => async ({ dispatch: r, select: a }) => {
                var s;
                ...
                if ((null == i ? void 0 : i.rate_id) !== e)
                    try {
                        ...
                        const { response: a } = await Ve({ path: "/wc/store/v1/cart/select-shipping-rate", method: "POST", data: { package_id: t, rate_id: e }, cache: "no-store" }),
            ...
            gt = (e, t = !0) => async ({ dispatch: r }) => {
                try {
                    r.updatingCustomerData(!0);
                    const { response: a } = await Ve({ path: "/wc/store/v1/cart/update-customer", method: "POST", data: e, cache: "no-store" });
        ...
        const It = (e, t) => Be(e) && "type" in e && e.type === t,
                ...
                return t
                    ? t.reduce(
                          (e, [t, { code: r, message: a, additional_errors: s = [] }]) => [
                              ...e,
                              { param: t, id: `${t}_${r}`, code: r, message: (0, Xe.decodeEntities)(a) },
                              ...(Array.isArray(s) ? s.flatMap((e) => (Fe(e, "code") && Fe(e, "message") ? [{ param: t, id: `${t}_${e.code}`, code: e.code, message: (0, Xe.decodeEntities)(e.message) }] : [])) : []),
                          ],
                          []
                      )
                    : [];
            ...
            Yt = (e, t) => {
                ...
                "invalid_json" === e.code && (r = ze), Ke("error", r, { id: e.code, context: t || xt(e.code) });
            },
            Ut = window.wp.url,
            ...
            qt = { customerDataIsInitialized: !1, doingPush: !1, customerData: { billingAddress: {}, shippingAddress: {} }, dirtyProps: { billingAddress: [], shippingAddress: [] } },
            Bt = () => {
                ...
                if (
                    ...
                    (() => {
                        ...
                        (qt.dirtyProps.billingAddress = [...qt.dirtyProps.billingAddress, ...Vt(qt.customerData.billingAddress, e.billingAddress)]),
                            (qt.dirtyProps.shippingAddress = [...qt.dirtyProps.shippingAddress, ...Vt(qt.customerData.shippingAddress, e.shippingAddress)]),
                            (qt.customerData = e);
                    })(),
                    !(qt.dirtyProps.billingAddress.length > 0 || qt.dirtyProps.shippingAddress.length > 0))
                )
                ...
                if (
                    ...
                    return void (qt.doingPush = !1);
                const e = {};
                qt.dirtyProps.billingAddress.length && (e.billing_address = Tt(qt.customerData.billingAddress, qt.dirtyProps.billingAddress)),
                    qt.dirtyProps.shippingAddress.length && (e.shipping_address = Tt(qt.customerData.shippingAddress, qt.dirtyProps.shippingAddress)),
                    (0, T.dispatch)(b)
                ...
                reducer: (e = q, t) => {
                    switch (t.type) {
                        ...
                        case Se:
                            ...
                            break;
                        case ve:
                            (t.couponCode || "" === t.couponCode) && (e = { ...e, metaData: { ...e.metaData, applyingCoupon: t.couponCode } });
                            break;
                        case Ce:
                            e = { ...e, cartData: { ...e.cartData, billingAddress: { ...e.cartData.billingAddress, ...t.billingAddress } } };
                            break;
                        case Ie:
                            e = { ...e, cartData: { ...e.cartData, shippingAddress: { ...e.cartData.shippingAddress, ...t.shippingAddress } } };
                            break;
                        case Te:
                            (t.couponCode || "" === t.couponCode) && (e = { ...e, metaData: { ...e.metaData, removingCoupon: t.couponCode } });
                            break;
                        case Pe:
                            const r = e.cartItemsPendingQuantity.filter((e) => e !== t.cartItemKey);
                            t.isPendingQuantity && t.cartItemKey && r.push(t.cartItemKey), (e = { ...e, cartItemsPendingQuantity: r });
                            break;
                        case Re:
                            const a = e.cartItemsPendingDelete.filter((e) => e !== t.cartItemKey);
                            t.isPendingDelete && t.cartItemKey && a.push(t.cartItemKey), (e = { ...e, cartItemsPendingDelete: a });
                            break;
                        case Ae:
                            e = { ...e, errors: N, cartData: { ...e.cartData, items: vt(e.cartData.items, t) } };
                            break;
                        case we:
        ...
        Xt.subscribe((e = !0) => {
            if ((0, T.select)(b).hasFinishedResolution("getCartData"))
                return qt.customerDataIsInitialized
                    ? void (bt()(qt.customerData, (0, T.select)(b).getCustomerData()) || (e ? Ft() : Bt()))
                    : ((qt.customerData = (0, T.select)(b).getCustomerData()), void (qt.customerDataIsInitialized = !0));
        }),
        ...
        const er = { order_id: 0, customer_id: 0, billing_address: {}, shipping_address: {}, ...((0, w.getSetting)("checkoutData", {}) || {}) };
        var tr, rr, ar, sr, ir, nr, or, cr, lr, dr;
        const ur = (0, w.getSetting)("wcBlocksConfig", { buildPhase: 1, pluginUrl: "", productCount: 0, defaultAvatar: "", restApiRoutes: {}, wordCountType: "words" }),
            ...
            _r =
                ...
                null !== (dr = w.STORE_PAGES.myaccount) && void 0 !== dr && dr.permalink ? w.STORE_PAGES.myaccount.permalink : (0, w.getSetting)("wpLoginUrl", "/wp-login.php"),
            ...
            yr =
                ...
                Object.fromEntries(Object.keys(hr).map((e) => [e, hr[e].locale || []]))),
            Er = { address: ["first_name", "last_name", "company", "address_1", "address_2", "city", "postcode", "country", "state", "phone"], contact: ["email"], additional: [] },
            ...
            ra = (e) => ({ dispatch: t }) => {
                const r = ((e) => {
                    ...
                    return (
                        ...
                        !t.message && "data" in e && "status" in e.data && e.data.status > 299 && (t.message = (0, P.__)("Something went wrong. Please contact us to get assistance.", "woocommerce")),
                        t
                    );
                })(e);
            ...
            aa = ({ observers: e, setValidationErrors: t }) => ({ dispatch: r, registry: a }) => {
                ...
                ((e, t) => {
                    ...
                    (async (e, t, r) => {
                        ...
                        !0 !== e
                            ? (Array.isArray(e) &&
                                  e.forEach(({ errorMessage: e, validationErrors: r, context: a = "wc/checkout" }) => {
                                      s(e, { context: a }), t(r);
                                  }),
                              r.__internalSetIdle(),
            ...
            sa = ({ observers: e, notices: t }) => ({ select: r, dispatch: a, registry: s }) => {
                const { createErrorNotice: i } = s.dispatch(v.store),
                    n = { redirectUrl: r.getRedirectUrl(), orderId: r.getOrderId(), customerId: r.getCustomerId(), orderNotes: r.getOrderNotes(), processingResponse: (0, T.select)($t).getPaymentResult() };
                r.hasError()
                    ? ea(e, "checkout_fail", n).then((e) => {
                          (({ observerResponses: e, notices: t, dispatch: r, createErrorNotice: a, data: s }) => {
                              const i = (({ observerResponses: e, createErrorNotice: t }) => {
                                  let r = null;
                                  return (
                                      e.forEach((e) => {
                                          if ((Ot(e) || Mt(e)) && e.message && fr(e.message)) {
                                              const a = e.messageContext && fr(e.messageContext) ? { context: e.messageContext } : void 0;
                                              (r = e), t(e.message, a);
                                          }
                                      }),
                                      r
                              ...
                              if (null !== i) kt(i) ? r.__internalSetIdle() : r.__internalSetComplete(i);
                                  ...
                                  t.checkoutNotices.some((e) => "error" === e.status) ||
                                      ...
                                      a((null === (n = s.processingResponse) || void 0 === n ? void 0 : n.message) || (0, P.__)("Something went wrong. Please contact us to get assistance.", "woocommerce"), {
                                          id: "checkout",
                                          context: "wc/checkout",
                                      }),
                                      r.__internalSetIdle();
                          ...
                          (({ observerResponses: e, dispatch: t, createErrorNotice: r }) => {
                              ...
                              if (
                                  ...
                                  if (s.message && fr(s.message)) {
                                      const e = s.messageContext && fr(s.messageContext) ? { context: s.messageContext } : void 0;
                                      r(s.message, e);
                                  }
            ...
            Sa = (e, t, r = !1) => ({ type: Zr, extensionData: t, namespace: e, replace: r }),
            fa = (e) => {
                const t = {};
                return (
                    ...
                    void 0 === e.label || e.optionalLabel || (t.optionalLabel = (0, P.sprintf) /* translators: %s Field label. */(/* translators: %s Field label. */ (0, P.__)("%s (optional)", "woocommerce"), e.label)),
                    e.priority && ("number" == typeof e.priority && (t.index = e.priority), fr(e.priority) && (t.index = parseInt(e.priority, 10))),
            ...
            Ta = (e) => {
                const t = ((e, t, r = "") => {
                        ...
                        return e.map((e) => ({ key: e, ...(w.defaultFields[e] || {}), ...(a[e] || {}), ...(t[e] || {}) })).sort((e, t) => e.index - t.index);
                    })(gr, {}, e.country),
                    r = Object.assign({}, e);
                return (
                ...
                reducer: (e = Aa, t) => {
                    ...
                    switch (t.type) {
                        case Ur:
                            ...
                            break;
                        case jr:
                            a = void 0 !== t.redirectUrl && t.redirectUrl !== e.redirectUrl ? { ...e, redirectUrl: t.redirectUrl } : e;
                            break;
                        case Hr:
                            a = { ...e, status: Jt.COMPLETE, redirectUrl: "string" == typeof (null === (r = t.data) || void 0 === r ? void 0 : r.redirectUrl) ? t.data.redirectUrl : e.redirectUrl };
                            break;
                        case Br:
                        ...
                        case qr:
                            ...
                            break;
                        case Fr:
                            a = { ...e, hasError: t.hasError, status: e.status === Jt.PROCESSING || e.status === Jt.BEFORE_PROCESSING ? Jt.IDLE : e.status };
                            break;
                        case zr:
                        ...
                        case $r:
                            ...
                            break;
                        case Xr:
                            void 0 !== t.useShippingAsBilling && t.useShippingAsBilling !== e.useShippingAsBilling && (a = { ...e, useShippingAsBilling: t.useShippingAsBilling });
                            break;
                        case Qr:
                            void 0 !== t.shouldCreateAccount && t.shouldCreateAccount !== e.shouldCreateAccount && (a = { ...e, shouldCreateAccount: t.shouldCreateAccount });
                            break;
                        case Wr:
                            void 0 !== t.prefersCollection && t.prefersCollection !== e.prefersCollection && (a = { ...e, prefersCollection: t.prefersCollection });
                            break;
                        case Gr:
                            void 0 !== t.orderNotes && e.orderNotes !== t.orderNotes && (a = { ...e, orderNotes: t.orderNotes });
                            break;
                        case Zr:
                            void 0 !== t.extensionData && void 0 !== t.namespace && (a = { ...e, extensionData: { ...e.extensionData, [t.namespace]: t.replace ? t.extensionData : { ...e.extensionData[t.namespace], ...t.extensionData } } });
                    }
                    return a;
                },
                selectors: i,
        ...
        const ka = ({ state: e, namespace: t, resourceName: r, query: a, ids: s, type: i = "items", fallback: n = Da }) =>
                Ma(e, [t, r, (s = JSON.stringify(s)), (a = null !== a ? (0, Ut.addQueryArgs)("", a) : ""), i]) ? e[t][r][s][a][i] : n,
            Na = (e, t, r, a = null, s = Da) => ka({ state: e, namespace: t, resourceName: r, query: a, ids: s }),
            xa = (e, t, r, a = null, s = Da) => ka({ state: e, namespace: t, resourceName: r, query: a, ids: s, type: "error", fallback: null }),
            La = (e, t, r, a, s = null, i = Da) => {
                const n = ((e, t, r, a = null, s = Da) => ka({ state: e, namespace: t, resourceName: r, query: a, ids: s, type: "headers", fallback: void 0 }))(e, r, a, s, i);
                return n && n.get ? (n.has(t) ? n.get(t) : void 0) : null;
            },
            Ya = (e) => e.lastModified || 0,
            Ua = { RECEIVE_COLLECTION: "RECEIVE_COLLECTION", RESET_COLLECTION: "RESET_COLLECTION", ERROR: "ERROR", RECEIVE_LAST_MODIFIED: "RECEIVE_LAST_MODIFIED", INVALIDATE_RESOLUTION_FOR_STORE: "INVALIDATE_RESOLUTION_FOR_STORE" };
        let ja = window.Headers || null;
        function Ha(e, t, r = "", a = [], s = { items: [], headers: ja }, i = !1) {
            return { type: i ? Ua.RESET_COLLECTION : Ua.RECEIVE_COLLECTION, namespace: e, resourceName: t, queryString: r, ids: a, response: s };
        }
        function Va(e, t, r, a, s) {
            return { type: "ERROR", namespace: e, resourceName: t, queryString: r, ids: a, response: { items: [], headers: ja, error: s } };
        }
        function qa(e) {
        ...
        const Ka = (0, T.createReduxStore)(Ia, {
            reducer: (e = {}, t) => {
                if (t.type === Ua.RECEIVE_LAST_MODIFIED) return t.timestamp === e.lastModified ? e : { ...e, lastModified: t.timestamp };
        ...
        const Za = (e) =>
            ...
            es = [
                {
                    destination: { address_1: "", address_2: "", city: "", state: "", postcode: "", country: "" },
                    package_id: 0,
                    name: (0, P.__)("Shipping", "woocommerce"),
                    items: [
                        { key: "33e75ff09dd601bbe69f351039152189", name: (0, P._x)("Beanie with Logo", "example product in Cart Block", "woocommerce"), quantity: 2 },
                        { key: "6512bd43d9caa6e02c990b0a82652dca", name: (0, P._x)("Beanie", "example product in Cart Block", "woocommerce"), quantity: 1 },
                    ],
                    shipping_rates: [
                        {
                            currency_code: "USD",
            ...
            rs = {
                ...
                items: [
                    {
                        ...
                        images: [{ id: 10, src: pr + "previews/beanie.jpg", thumbnail: pr + "previews/beanie.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        variation: [
                            { attribute: (0, P.__)("Color", "woocommerce"), value: (0, P.__)("Yellow", "woocommerce") },
                            { attribute: (0, P.__)("Size", "woocommerce"), value: (0, P.__)("Small", "woocommerce") },
                        ],
                        prices: {
                            currency_code: "USD",
                            currency_symbol: "$",
                            ...
                            price_range: null,
                            raw_prices: { precision: 6, price: ts ? "12000000" : "10000000", regular_price: ts ? "12000000" : "10000000", sale_price: ts ? "12000000" : "10000000" },
                        },
                        totals: {
                            currency_code: "USD",
                            currency_symbol: "$",
                    ...
                    },
                    {
                        ...
                        sold_individually: !1,
                        quantity_limits: { minimum: 1, maximum: 99, multiple_of: 1, editable: !0 },
                        images: [{ id: 11, src: pr + "previews/cap.jpg", thumbnail: pr + "previews/cap.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        variation: [{ attribute: (0, P.__)("Color", "woocommerce"), value: (0, P.__)("Orange", "woocommerce") }],
                        prices: {
                            currency_code: "USD",
                            currency_symbol: "$",
                            currency_minor_unit: 2,
                            ...
                            price_range: null,
                            raw_prices: { precision: 6, price: ts ? "24000000" : "20000000", regular_price: ts ? "24000000" : "20000000", sale_price: ts ? "24000000" : "20000000" },
                        },
                        totals: {
                            currency_code: "USD",
                            currency_symbol: "$",
                ...
                cross_sells: [
                    {
                        ...
                        average_rating: "4.5",
                        review_count: 2,
                        images: [{ id: 17, src: pr + "previews/polo.jpg", thumbnail: pr + "previews/polo.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                        ...
                        low_stock_remaining: null,
                        sold_individually: !1,
                        add_to_cart: { text: "", description: "", url: "", minimum: 1, maximum: 99, multiple_of: 1 },
                    },
                    {
                        id: 2,
                        ...
                        average_rating: "4",
                        review_count: 2,
                        images: [{ id: 17, src: pr + "previews/long-sleeve-tee.jpg", thumbnail: pr + "previews/long-sleeve-tee.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                    ...
                    },
                    {
                        ...
                        average_rating: "1",
                        review_count: 2,
                        images: [{ id: 17, src: pr + "previews/hoodie-with-zipper.jpg", thumbnail: pr + "previews/hoodie-with-zipper.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                    ...
                    },
                    {
                        ...
                        average_rating: "5",
                        review_count: 2,
                        images: [{ id: 17, src: pr + "previews/hoodie-with-logo.jpg", thumbnail: pr + "previews/hoodie-with-logo.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                    ...
                    },
                    {
                        ...
                        average_rating: "3.75",
                        review_count: 4,
                        images: [{ id: 17, src: pr + "previews/hoodie-with-pocket.jpg", thumbnail: pr + "previews/hoodie-with-pocket.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                    ...
                    },
                    {
                        ...
                        average_rating: "3",
                        review_count: 2,
                        images: [{ id: 17, src: pr + "previews/tshirt.jpg", thumbnail: pr + "previews/tshirt.jpg", srcset: "", sizes: "", name: "", alt: "" }],
                        categories: [],
                        tags: [],
                        attributes: [],
                        variations: [],
                ...
                shipping_address: { first_name: "", last_name: "", company: "", address_1: "", address_2: "", city: "", state: "", postcode: "", country: "", phone: "" },
            ...
            as = (e, t, r = !1) => {
                ...
                a(
                    `${(0, P.sprintf) /* translators: %s the id of the payment method being registered (bank transfer, cheque...) */(
                        /* translators: %s the id of the payment method being registered (bank transfer, cheque...) */
                        (0, P.__)("There was an error registering the payment method with id '%s': ", "woocommerce"),
                        e.paymentMethodId
                    )} ${t}`,
            ...
            ss = async (e = !1) => {
                ...
                const { __internalSetAvailablePaymentMethods: d, __internalSetAvailableExpressPaymentMethods: u } = (0, T.dispatch)($t);
                return (e ? u : d)(t), !0;
            },
            is = async (e) => {
                ...
                if (i) {
                    ...
                    return void (0, T.dispatch)($t).__internalSetActivePaymentMethod(t, { token: e, payment_method: t, [r]: e, isSavedToken: !0 });
                }
        ...
        const cs = (e) => ["first_name", "last_name", "company", "address_1", "address_2", "city", "state", "postcode", "country", "phone"].every((t) => Fe(e, t)),
            ...
            ds = (e) => ({ registry: t }) => {
                ...
                e ? r(e, { id: "wc-express-payment-error", context: Ct.EXPRESS_PAYMENTS }) : a("wc-express-payment-error", Ct.EXPRESS_PAYMENTS);
            },
            us = (e, t) => ({ dispatch: r, registry: a }) => {
                ...
                return (
                    ...
                    ea(e, "payment_setup", {}).then((e) => {
                        ...
                        e.forEach((e) => {
                            ...
                            const { billingAddress: t, billingData: r, shippingAddress: a, shippingData: s } = (null == e ? void 0 : e.meta) || {};
                            (o = t),
                                (c = a),
                                r &&
                                    ((o = r),
                                    os()("returning billingData from an onPaymentProcessing observer in WooCommerce Blocks", {
                                        version: "9.5.0",
                                ...
                                Fe(s, "address") &&
                                    s.address &&
                                    ((c = s.address),
                                    os()("returning shippingData from an onPaymentProcessing observer in WooCommerce Blocks", {
                                        version: "9.5.0",
                                        alternative: "shippingAddress",
                                        link: "https://github.com/woocommerce/woocommerce-blocks/pull/8163",
                                    }));
                        });
                        const { setBillingAddress: l, setShippingAddress: d } = a.dispatch(Wt);
                        if (Jr(i) && !n) {
                            var u;
                            const { paymentMethodData: e } = (null === (u = i) || void 0 === u ? void 0 : u.meta) || {};
                            ls(o) && l(o), cs(c) && d(c), r.__internalSetPaymentMethodData(Be(e) ? e : {}), r.__internalSetPaymentReady();
                        } else if (Mt(n)) {
                            var p;
                            const { paymentMethodData: e } = (null === (p = n) || void 0 === p ? void 0 : p.meta) || {};
                            if (Fe(n, "message") && fr(n.message) && n.message.length) {
                                let e = Ct.PAYMENTS;
                                Fe(n, "messageContext") && fr(n.messageContext) && n.messageContext.length && (e = n.messageContext), s(n.message, { id: "wc-payment-error", isDismissible: !1, context: e });
                            }
            ...
            fs = (e, t = {}) => ({ type: Wa.SET_ACTIVE_PAYMENT_METHOD, activePaymentMethod: e, paymentMethodData: t }),
            vs = (e = {}) => ({ type: Wa.SET_PAYMENT_METHOD_DATA, paymentMethodData: e }),
            Ts = (e) => ({ type: Wa.SET_PAYMENT_RESULT, data: e }),
            As = (e) => async ({ dispatch: t, select: r }) => {
                r.getActivePaymentMethod() in e || (await is(e)), t({ type: Wa.SET_AVAILABLE_PAYMENT_METHODS, paymentMethods: e });
            },
        ...
        const Is = (e) => (os()("isPaymentPristine", { since: "9.6.0", alternative: "isPaymentIdle", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), e.status === Gt.IDLE),
            Ds = (e) => e.status === Gt.IDLE,
            Os = (e) => (
                os()("isPaymentStarted", { since: "9.6.0", alternative: "isExpressPaymentStarted", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), e.status === Gt.EXPRESS_STARTED
            ),
            Ms = (e) => e.status === Gt.EXPRESS_STARTED,
            ks = (e) => e.status === Gt.PROCESSING,
            Ns = (e) => e.status === Gt.READY,
            xs = (e) => (os()("isPaymentSuccess", { since: "9.6.0", alternative: "isPaymentReady", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), e.status === Gt.READY),
            Ls = (e) => e.status === Gt.ERROR,
            Ys = (e) => (os()("isPaymentFailed", { since: "9.6.0", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), e.status === Gt.ERROR),
            ...
            Fs = (e) => {
                const { availablePaymentMethods: t, availableExpressPaymentMethods: r, paymentMethodsInitialized: a, expressPaymentMethodsInitialized: s } = e;
                return a && s ? Object.fromEntries(Object.entries(Cs).filter(([e]) => !(e in { ...t, ...r }))) : {};
            },
            ...
            Xs = (e) => (
                os()("getCurrentStatus", { since: "8.9.0", alternative: "isPaymentIdle, isPaymentProcessing, hasPaymentError", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/7666" }),
                {
                    get isPristine() {
                        return os()("isPristine", { since: "9.6.0", alternative: "isIdle", plugin: "WooCommerce Blocks" }), Ds(e);
                    },
                    isIdle: Ds(e),
                    isStarted: Ms(e),
                    isProcessing: ks(e),
                    get isFinished() {
                        return os()("isFinished", { since: "9.6.0", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), Ls(e) || Ns(e);
                    },
                    hasError: Ls(e),
                    get hasFailed() {
                        return os()("hasFailed", { since: "9.6.0", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), Ls(e);
                    },
                    get isSuccessful() {
                        return os()("isSuccessful", { since: "9.6.0", plugin: "WooCommerce Blocks", link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110" }), Ns(e);
                    },
                ...
                reducer: (e = Qa, t) => {
                    ...
                    switch (t.type) {
                        ...
                        case Wa.SET_ACTIVE_PAYMENT_METHOD:
                            ...
                            r = { ...e, activeSavedToken: i, activePaymentMethod: t.activePaymentMethod, paymentMethodData: t.paymentMethodData || e.paymentMethodData };
                            break;
                        default:
                            return r;
                    }
        ...
        const ui = ri,
            pi = (0, T.createRegistrySelector)((e) => (t, r, a, s = []) => {
                ...
                let n = "";
                if (
                    ((t = t.routes)[r] ? t[r][a] || (n = (0, P.sprintf)("There is no route for the given resource name (%s) in the store", a)) : (n = (0, P.sprintf)("There is no route for the given namespace (%s) in the store", r)),
                    "" !== n)
                ) {
        ...
        const gi = (0, T.combineReducers)({
            ...
            Si = (0, T.createReduxStore)(Ba, { reducer: gi, actions: h, controls: A.controls, selectors: m, resolvers: y });
        (0, T.register)(Si);
        const fi = Ba;
        let vi = (function (e) {
        ...
        const Ii = Ri,
            ...
            Gi = {
                reducer: (e = {}, t) => {
                    ...
                    switch (t.type) {
                        case Di:
                            return t.errors && Object.entries(t.errors).some(([t, r]) => !("string" != typeof (null == r ? void 0 : r.message) || (e.hasOwnProperty(t) && bt()(e[t], r)))) ? { ...e, ...t.errors } : e;
                        case Oi:
