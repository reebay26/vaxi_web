...
function popupaoc_set_popup_events(target, options, data_opts) {
    ...
    options.content.onOpen = function () {
        ...
        jQuery(".custombox-overlay")
            .not(".paoc-popup-overlay")
            .addClass("paoc-popup-active paoc-popup-overlay paoc-popup-overlay-" + data_opts.id);

        /* Add Classes from Popup Content */
        jQuery(".custombox-content")
            .not(".paoc-cb-popup")
            .addClass("paoc-popup-active paoc-cb-popup paoc-cb-popup-" + data_opts.id + " paoc-popup-" + options.content.positionX + "-" + options.content.positionY);
