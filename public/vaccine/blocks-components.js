(() => {
                ...
                e.exports = (function () {
                    ...
                    return (function t() {
                        ...
                        var he,
                            ...
                            dt = function (t) {
                                (lt && lt === t) ||
                                    ...
                                    (xe = "ALLOWED_TAGS" in t ? _({}, t.ALLOWED_TAGS, ge) : Ae),
                                    (Te = "ALLOWED_ATTR" in t ? _({}, t.ALLOWED_ATTR, ge) : ke),
                                    (at = "ALLOWED_NAMESPACES" in t ? _({}, t.ALLOWED_NAMESPACES, b) : it),
                                    (qe = "ADD_URI_SAFE_ATTR" in t ? _(R(Qe), t.ADD_URI_SAFE_ATTR, ge) : Qe),
                                    (Je = "ADD_DATA_URI_TAGS" in t ? _(R(Xe), t.ADD_DATA_URI_TAGS, ge) : Xe),
                                    (ze = "FORBID_CONTENTS" in t ? _({}, t.FORBID_CONTENTS, ge) : Ye),
                                    (Re = "FORBID_TAGS" in t ? _({}, t.FORBID_TAGS, ge) : {}),
                                    (Me = "FORBID_ATTR" in t ? _({}, t.FORBID_ATTR, ge) : {}),
                                    (We = "USE_PROFILES" in t && t.USE_PROFILES),
                                    (Le = !1 !== t.ALLOW_ARIA_ATTR),
                                    (Oe = !1 !== t.ALLOW_DATA_ATTR),
                                    (De = t.ALLOW_UNKNOWN_PROTOCOLS || !1),
                                    ($e = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR),
                                    ...
                                    (Be = t.FORCE_BODY || !1),
                                    (Ge = !1 !== t.SANITIZE_DOM),
                                    (Ze = t.SANITIZE_NAMED_PROPS || !1),
                                    (Ke = !1 !== t.KEEP_CONTENT),
                                    (je = t.IN_PLACE || !1),
                                    (Se = t.ALLOWED_URI_REGEXP || Se),
                                    (ot = t.NAMESPACE || nt),
                                    (_e = t.CUSTOM_ELEMENT_HANDLING || {}),
                                    t.CUSTOM_ELEMENT_HANDLING && ut(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (_e.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                                    t.CUSTOM_ELEMENT_HANDLING && ut(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (_e.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                                    t.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (_e.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
                                    Ie && (Oe = !1),
                                    Ve && (He = !0),
                                    We &&
                                        ((xe = _({}, o(F))),
                                        (Te = []),
                                        !0 === We.html && (_(xe, L), _(Te, B)),
                                        !0 === We.svg && (_(xe, O), _(Te, H), _(Te, U)),
                                        !0 === We.svgFilters && (_(xe, D), _(Te, H), _(Te, U)),
                                        !0 === We.mathMl && (_(xe, I), _(Te, V), _(Te, U))),
                                    t.ADD_TAGS && (xe === Ae && (xe = R(xe)), _(xe, t.ADD_TAGS, ge)),
                                    t.ADD_ATTR && (Te === ke && (Te = R(Te)), _(Te, t.ADD_ATTR, ge)),
                                    t.ADD_URI_SAFE_ATTR && _(qe, t.ADD_URI_SAFE_ATTR, ge),
                                    t.FORBID_CONTENTS && (ze === Ye && (ze = R(ze)), _(ze, t.FORBID_CONTENTS, ge)),
                                    Ke && (xe["#text"] = !0),
                                    Pe && _(xe, ["html", "head", "body"]),
                                    xe.table && (_(xe, ["tbody"]), delete Re.tbody),
                                    u && u(t),
                                    (lt = t));
                            },
                        ...
                        var vt = function (e) {
                            ...
                            yt = function (e, t) {
                                try {
                                    C(r.removed, { attribute: t.getAttributeNode(e), from: t });
                                } catch (e) {
                                    C(r.removed, { attribute: null, from: t });
                                }
                            ...
                            Nt = function (e) {
                                ...
                                var o = ge(e.nodeName);
                                if (
                                    (wt("uponSanitizeElement", e, { tagName: o, allowedTags: xe }),
                                ...
                                if (!xe[o] || Re[o]) {
                                    ...
                                    if (Ke && !ze[o]) {
                                        var a = oe(e) || e.parentNode,
                                            i = ne(e) || e.childNodes;
                                        if (i && a) for (var s = i.length - 1; s >= 0; --s) a.insertBefore(ee(i[s], !0), te(e));
                                    }
                                    return vt(e), !0;
                                }
                                        ...
                                        return (
                                            ...
                                            (e.namespaceURI === tt
                                                ...
                                                ? t.namespaceURI === nt
                                                    ...
                                                    : Boolean(gt[n])
                                                : e.namespaceURI === nt
                                                ? !(t.namespaceURI === tt && !mt[o]) && !(t.namespaceURI === et && !pt[o]) && !gt[n] && (ft[n] || !ht[n])
                                                : !("application/xhtml+xml" !== he || !at[e.namespaceURI]))
                                        );
                                    })(e)
                                    ? (vt(e), !0)
                                    : ("noscript" !== o && "noembed" !== o && "noframes" !== o) || !A(/<\/no(script|embed|frames)/i, e.innerHTML)
                                    ? (Ie && 3 === e.nodeType && ((t = e.textContent), (t = N(t, ve, " ")), (t = N(t, ye, " ")), (t = N(t, Ce, " ")), e.textContent !== t && (C(r.removed, { element: e.cloneNode() }), (e.textContent = t))),
                            ...
                            St = function (e, t, n) {
                                ...
                                if (Oe && !Me[t] && A(Ee, t));
                                    ...
                                    if (
                                        !(
                                            (xt(e) &&
                                                ((_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, e)) || (_e.tagNameCheck instanceof Function && _e.tagNameCheck(e))) &&
                                                ((_e.attributeNameCheck instanceof RegExp && A(_e.attributeNameCheck, t)) || (_e.attributeNameCheck instanceof Function && _e.attributeNameCheck(t)))) ||
                                            ("is" === t && _e.allowCustomizedBuiltInElements && ((_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, n)) || (_e.tagNameCheck instanceof Function && _e.tagNameCheck(n))))
                                        )
                                    )
                                        return !1;
                                } else if (qe[t]);
                                ...
                                if (s) {
                                    ...
                                    for (i = s.length; i--; ) {
                                        ...
                                        if (
                                            ...
                                            (o = l.attrValue),
                                            !l.forceKeepAttr && (yt(u, t), l.keepAttr))
                                        )
                                            if ($e || !A(/\/>/i, o)) {
                        ...
                        return (
                            (r.sanitize = function (t) {
                                ...
                                if (He) {
                                    if (Ve) for (d = ue.call(o.ownerDocument); o.firstChild; ) d.appendChild(o.firstChild);
                                    else d = o;
                                    return (Te.shadowroot || Te.shadowrootmod) && (d = pe.call(a, d, !0)), d;
                                }
                                var h = Pe ? o.outerHTML : o.innerHTML;
                                return (
                                    Pe && xe["!doctype"] && o.ownerDocument && o.ownerDocument.doctype && o.ownerDocument.doctype.name && A(X, o.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + h),
                                    Ie && ((h = N(h, ve, " ")), (h = N(h, ye, " ")), (h = N(h, Ce, " "))),
                                    ae && Ue ? ae.createHTML(h) : h
                                );
                            }),
    ...
    (() => {
        ...
        const d = window.wp.compose,
            ...
            f = (0, a.createElement)(m.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" }, (0, a.createElement)(m.Path, { d: "M13 11.8l6.1-6.3-1-1-6.1 6.2-6.1-6.2-1 1 6.1 6.3-6.5 6.7 1 1 6.5-6.6 6.5 6.6 1-1z" })),
            h = window.wp.i18n;
        function g(e, t, n) {
            const { defaultView: o } = t,
                { frameElement: r } = o;
        ...
        function w(e) {
            ...
            return {
                ...n,
                updateSlot: (0, a.useCallback)(
                    (n) => {
                        t.updateSlot(e, n);
                    },
                    [e, t.updateSlot]
                ),
                unregisterSlot: (0, a.useCallback)(
                    (n) => {
                ...
                fills: r,
                registerFill: (0, a.useCallback)(
                    (n) => {
                        t.registerFill(e, n);
                    },
                    [e, t.registerFill]
                ),
                unregisterFill: (0, a.useCallback)(
                    (n) => {
        ...
        const N = (0, a.createContext)({ registerSlot: () => {}, unregisterSlot: () => {}, registerFill: () => {}, unregisterFill: () => {}, getSlot: () => {}, getFills: () => {}, subscribe: () => {} });
        function S({ name: e, children: t, registerFill: n, unregisterFill: o }) {
            const r = ((e) => {
                    const { getSlot: t, subscribe: n } = (0, a.useContext)(N),
                        [o, r] = (0, a.useState)(t(e));
                    return (
                        (0, a.useEffect)(
                            () => (
                                r(t(e)),
                ...
                i = (0, a.useRef)({ name: e, children: t });
            return (
                (0, a.useLayoutEffect)(() => (n(e, i.current), () => o(e, i.current)), []),
                (0, a.useLayoutEffect)(() => {
                ...
                r && r.node ? ((0, l.isFunction)(t) && (t = t(r.props.fillProps)), (0, a.createPortal)(t, r.node)) : null
            );
        }
        const x = (e) => (0, a.createElement)(N.Consumer, null, ({ registerFill: t, unregisterFill: n }) => (0, a.createElement)(S, r({}, e, { registerFill: t, unregisterFill: n })));
        class A extends a.Component {
            ...
            componentDidUpdate(e) {
                const { name: t, unregisterSlot: n, registerSlot: o } = this.props;
            ...
            render() {
                const { children: e, name: t, fillProps: n = {}, getFills: o } = this.props,
                    r = (0, l.map)(o(t, this), (e) => {
                        const t = (0, l.isFunction)(e.children) ? e.children(n) : e.children;
                        return a.Children.map(t, (e, t) => {
                            if (!e || (0, l.isString)(e)) return e;
                            const n = e.key || t;
                            return (0, a.cloneElement)(e, { key: n });
                        });
                    }).filter((0, l.negate)(a.isEmptyElement));
                return (0, a.createElement)(a.Fragment, null, (0, l.isFunction)(e) ? e(r) : r);
            }
        }
        const T = (e) => (0, a.createElement)(N.Consumer, null, ({ registerSlot: t, unregisterSlot: n, getFills: o }) => (0, a.createElement)(A, r({}, e, { registerSlot: t, unregisterSlot: n, getFills: o })));
        function k() {
        ...
        function _({ name: e, children: t }) {
            const n = w(e),
                o = (0, a.useRef)({ rerender: k() });
            return (
                (0, a.useEffect)(
                    () => (
                        n.registerFill(o),
                ...
                n.ref && n.ref.current ? ("function" == typeof t && (t = t(n.fillProps)), (0, a.createPortal)(t, n.ref.current)) : null
            );
        }
        const R = (0, a.forwardRef)(function ({ name: e, fillProps: t = {}, as: n = "div", ...o }, i) {
            const s = (0, a.useContext)(b),
                l = (0, a.useRef)();
            return (
                (0, a.useLayoutEffect)(
                    () => (
                        s.registerSlot(e, l, t),
                        () => {
                ...
                (0, a.createElement)(n, r({ ref: (0, d.useMergeRefs)([i, l]) }, o))
            );
        });
        function M(e) {
            return (0, a.createElement)(a.Fragment, null, (0, a.createElement)(x, e), (0, a.createElement)(_, e));
        }
        const L = (0, a.forwardRef)(({ bubblesVirtually: e, ...t }, n) => (e ? (0, a.createElement)(R, r({}, t, { ref: n })) : (0, a.createElement)(T, t)));
        function O(e) {
            return "appear" === e ? "top" : "left";
        }
        const D = "Popover";
        function $(e, t) {
            const { paddingTop: n, paddingBottom: o, paddingLeft: r, paddingRight: a } = (i = t).ownerDocument.defaultView.getComputedStyle(i);
            var i;
            ...
            (
                ...
                (i = J || i),
                    (0, a.useLayoutEffect)(() => {
                        if (J)
                            return (
                                F(K.current, "is-without-arrow", i),
                                F(K.current, "is-alternate", l),
                                I(K.current, "data-x-axis"),
                                I(K.current, "data-y-axis"),
                                P(K.current, "top"),
                                P(K.current, "left"),
                                P(Z.current, "maxHeight"),
                                void P(Z.current, "maxWidth")
                            );
                        const e = () => {
                            ...
                            let e = (function (e, t, n, o = !1, r, a) {
                                ...
                                if (!e.current) return;
                                const { parentNode: i } = e.current,
                                    s = i.getBoundingClientRect();
                                return r ? s : $(s, i);
                            })(G, b, N, y, C, K.current);
                            if (!e) return;
                            const { offsetParent: t, ownerDocument: n } = K.current;
                            let o,
                                r = 0;
                            if (t && t !== n.body) {
                            ...
                            const s = Q.height ? Q : Z.current.getBoundingClientRect(),
                                { popoverTop: u, popoverLeft: d, xAxis: m, yAxis: f, contentHeight: v, contentWidth: E } = (function (e, t, n = "top", o, r, a, i, s, l) {
                                    const [c, u = "center", d] = n.split(" "),
                                        p = (function (e, t, n, o, r, a, i, s) {
                                            const { height: l } = t;
                                            if (r) {
                                        ...
                                        m = (function (e, t, n, o, r, a, i, s, l) {
                                            ...
                                            const f = { popoverLeft: p, contentWidth: p - c > 0 ? c : p },
                                                g = { popoverLeft: m, contentWidth: m + c > window.innerWidth ? window.innerWidth - m : c };
                                            let v,
                                                y = n,
                                                C = null;
                                            if (!r && !s)
                                            ...
                                            return { xAxis: y, popoverLeft: v, contentWidth: C };
                                        })(e, t, u, d, o, p.yAxis, i, s, l);
                                    return { ...m, ...p };
                                })(e, s, c, k, K.current, r, o, B, H);
                            "number" == typeof u && "number" == typeof d && (P(K.current, "top", u + "px"), P(K.current, "left", d + "px")),
                                F(K.current, "is-without-arrow", i || ("center" === m && "middle" === f)),
                                F(K.current, "is-alternate", l),
                                I(K.current, "data-x-axis", m),
                                I(K.current, "data-y-axis", f),
                                P(Z.current, "maxHeight", "number" == typeof v ? v + "px" : ""),
                                P(Z.current, "maxWidth", "number" == typeof E ? E + "px" : ""),
                                z(({ left: "right", right: "left" }[m] || "center") + " " + ({ top: "bottom", bottom: "top" }[f] || "middle"));
                        };
                        e();
                        const { ownerDocument: t } = K.current,
                            { defaultView: n } = t,
                            o = n.setInterval(e, 500);
                        let r;
                        const a = () => {
                        ...
                        let u;
                        return (
                            s && s !== t && (s.defaultView.addEventListener("resize", e), s.defaultView.addEventListener("scroll", e, !0)),
                            R && ((u = new n.MutationObserver(e)), u.observe(R, { attributes: !0 })),
                            () => {
                                n.clearInterval(o),
                                    ...
                                    s && s !== t && (s.defaultView.removeEventListener("resize", e), s.defaultView.removeEventListener("scroll", e, !0)),
                                    u && u.disconnect();
                            }
                        );
                    }, [J, b, N, y, C, c, Q, k, R, L]);
                const ee = (e, n) => {
                        if ("focus-outside" === e && T) T(n);
                            ...
                            Object.defineProperty(e, "target", { get: () => n.relatedTarget }), u()("Popover onClickOutside prop", { since: "5.3", alternative: "onFocusOutside" }), A(e);
                        } else t && t();
                    },
                    [te, ne] = (0, d.__experimentalUseDialog)({ focusOnMount: v, __unstableOnClose: ee, onClose: ee }),
                    oe = (0, d.useMergeRefs)([K, te, U]),
                    re =
                        Boolean(x && W) &&
                        (function (e) {
                            if ("loading" === e.type) return s()("components-animate__loading");
                            const { type: t, origin: n = O(t) } = e;
                            if ("appear" === t) {
                                const [e, t = "center"] = n.split(" ");
                                return s()("components-animate__appear", { ["is-from-" + t]: "center" !== t, ["is-from-" + e]: "middle" !== e });
                            }
                            return "slide-in" === t ? s()("components-animate__slide-in", "is-from-" + n) : void 0;
                        })({ type: "appear", origin: W });
                let ae = (0, a.createElement)(
                    "div",
                    r({ className: s()("components-popover", o, re, { "is-expanded": J, "is-without-arrow": i, "is-alternate": l }) }, V, { ref: oe }, ne, { tabIndex: "-1" }),
                    J && (0, a.createElement)(E, null),
                    J &&
                        (0, a.createElement)(
                            "div",
                            { className: "components-popover__header" },
                            (0, a.createElement)("span", { className: "components-popover__header-title" }, e),
                            (0, a.createElement)(X, { className: "components-popover__close", icon: f, onClick: t })
                        ),
                    (0, a.createElement)("div", { ref: Z, className: "components-popover__content" }, (0, a.createElement)("div", { style: { position: "relative" } }, q, n))
                );
                return Y.ref && (ae = (0, a.createElement)(M, { name: _ }, ae)), y || b ? ae : (0, a.createElement)("span", { ref: G }, ae);
            }
        );
        B.Slot = (0, a.forwardRef)(function ({ name: e = D }, t) {
            return (0, a.createElement)(L, { bubblesVirtually: !0, name: e, className: "popover-slot", ref: t });
        });
        const H = B,
            V = function ({ shortcut: e, className: t }) {
                if (!e) return null;
                let n, o;
                return (0, l.isString)(e) && (n = e), (0, l.isObject)(e) && ((n = e.display), (o = e.ariaLabel)), (0, a.createElement)("span", { className: t, "aria-label": o }, n);
            },
            U = (0, a.createElement)("div", { className: "event-catcher" }),
            G = ({ eventHandlers: e, child: t, childrenWithPopover: n }) =>
                (0, a.cloneElement)((0, a.createElement)("span", { className: "disabled-element-wrapper" }, (0, a.cloneElement)(U, e), (0, a.cloneElement)(t, { children: n }), ","), e),
            Z = ({ child: e, eventHandlers: t, childrenWithPopover: n }) => (0, a.cloneElement)(e, { ...t, children: n }),
            K = (e, t, n) => {
                if (1 !== a.Children.count(e)) return;
                const o = a.Children.only(e);
                "function" == typeof o.props[t] && o.props[t](n);
            },
            j = function ({ children: e, position: t, text: n, shortcut: o }) {
                const [r, i] = (0, a.useState)(!1),
                    [s, c] = (0, a.useState)(!1),
                    u = (0, d.useDebounce)(c, 700),
                    p = (t) => {
                    ...
                    f = (e) => ("mouseUp" === e ? m : "mouseDown" === e ? p : void 0),
                    h = f("mouseUp"),
                    g = (t, n) => (o) => {
                ...
                const y = { onMouseEnter: g("onMouseEnter", !0), onMouseLeave: g("onMouseLeave"), onClick: g("onClick"), onFocus: g("onFocus"), onBlur: g("onBlur"), onMouseDown: f("mouseDown") },
                    C = a.Children.only(e),
                    { children: E, disabled: b } = C.props,
                    w = b ? G : Z,
                    N = (({ grandchildren: e, isOver: t, position: n, text: o, shortcut: r }) =>
                        (0, a.concatChildren)(
                            e,
                            t &&
                                (0, a.createElement)(
                                    ...
                                    o,
                                    (0, a.createElement)(V, { className: "components-tooltip__shortcut", shortcut: r })
                                )
                        ))({ grandchildren: E, isOver: s, position: t, text: n, shortcut: o });
                return w({ child: C, eventHandlers: y, childrenWithPopover: N });
            },
            W = function ({ icon: e, className: t, ...n }) {
                const o = ["dashicon", "dashicons", "dashicons-" + e, t].filter(Boolean).join(" ");
                return (0, a.createElement)("span", r({ className: o }, n));
            },
            z = function ({ icon: e = null, size: t = 24, ...n }) {
                if ("string" == typeof e) return (0, a.createElement)(W, r({ icon: e }, n));
                if ((0, a.isValidElement)(e) && W === e.type) return (0, a.cloneElement)(e, { ...n });
                if ("function" == typeof e) return e.prototype instanceof a.Component ? (0, a.createElement)(e, { size: t, ...n }) : e({ size: t, ...n });
                if (e && ("svg" === e.type || e.type === m.SVG)) {
                    const o = { width: t, height: t, ...e.props, ...n };
                    return (0, a.createElement)(m.SVG, o);
                }
                return (0, a.isValidElement)(e) ? (0, a.cloneElement)(e, { size: t, ...n }) : e;
            },
            Y = (0, a.forwardRef)(function ({ as: e = "div", className: t, ...n }, o) {
                return (function ({ as: e = "div", ...t }) {
                    return "function" == typeof t.children ? t.children(t) : (0, a.createElement)(e, t);
                })({ as: e, className: s()("components-visually-hidden", t), ...n, ref: o });
            }),
            ...
            X = (0, a.forwardRef)(function (e, t) {
                const {
                        ...
                        describedBy: A,
                        ...T
                    } = (function ({ isDefault: e, isPrimary: t, isSecondary: n, isTertiary: o, isLink: r, variant: a, ...i }) {
                        let s = a;
                        var l, c, d, p, m;
                        return (
                            t && ((null !== (l = s) && void 0 !== l) || (s = "primary")),
                            o && ((null !== (c = s) && void 0 !== c) || (s = "tertiary")),
                            n && ((null !== (d = s) && void 0 !== d) || (s = "secondary")),
                            e && (u()("Button isDefault prop", { since: "5.4", alternative: 'variant="secondary"' }), (null !== (p = s) && void 0 !== p) || (s = "secondary")),
                            r && ((null !== (m = s) && void 0 !== m) || (s = "link")),
                            { ...i, variant: s }
                        );
                    })(e),
                    k = s()("components-button", m, {
                    ...
                    _ = f && !x,
                    R = void 0 === n || _ ? "button" : "a",
                    M = "a" === R ? { href: n, target: o } : { type: "button", disabled: _, "aria-pressed": c };
                if (f && x) {
                    M["aria-disabled"] = !0;
                    for (const e of J)
                        T[e] = (e) => {
                ...
                const L = !_ && ((y && b) || E || (!!b && (!w || ((0, l.isArray)(w) && !w.length)) && !1 !== y)),
                    ...
                    $ = (0, a.createElement)(
                        R,
                        r({}, M, T, { className: k, "aria-label": T["aria-label"] || b, "aria-describedby": D, ref: t }),
                        h && "left" === g && (0, a.createElement)(z, { icon: h, size: v }),
                        N && (0, a.createElement)(a.Fragment, null, N),
                        h && "right" === g && (0, a.createElement)(z, { icon: h, size: v }),
                        w
                    );
                return L
                    ? (0, a.createElement)(a.Fragment, null, (0, a.createElement)(j, { text: A || b, shortcut: E, position: C }, $), A && (0, a.createElement)(Y, null, (0, a.createElement)("span", { id: O }, A)))
                    : (0, a.createElement)(a.Fragment, null, $, A && (0, a.createElement)(Y, null, (0, a.createElement)("span", { id: O }, A)));
            });
        var q = n(849),
            Q = n.n(q);
        n(29), n(440);
        const ee = () => (0, e.createElement)("span", { className: "wc-block-components-spinner", "aria-hidden": "true" }),
            te = ({ className: t, showSpinner: n = !1, children: o, variant: r = "contained", ...a }) => {
                const i = Q()("wc-block-components-button", "wp-element-button", t, r, { "wc-block-components-button--loading": n });
                return (0, e.createElement)(X, { className: i, ...a }, n && (0, e.createElement)(ee, null), (0, e.createElement)("span", { className: "wc-block-components-button__text" }, o));
            },
            ne = te;
        n(866);
        const oe = ({ className: t, label: n, id: o, onChange: r, children: a, hasError: i = !1, checked: s = !1, disabled: l = !1, ...c }) => {
                const u = (0, d.useInstanceId)(oe),
                    p = o || `checkbox-control-${u}`;
                return (0, e.createElement)(
                    "div",
                    { className: Q()("wc-block-components-checkbox", { "has-error": i }, t) },
                    (0, e.createElement)(
                        "label",
                        { htmlFor: p },
                        (0, e.createElement)("input", { id: p, className: "wc-block-components-checkbox__input", type: "checkbox", onChange: (e) => r(e.target.checked), "aria-invalid": !0 === i, checked: s, disabled: l, ...c }),
                        (0, e.createElement)(
                            "svg",
                            { className: "wc-block-components-checkbox__mark", "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 20" },
                            (0, e.createElement)("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ),
                        n && (0, e.createElement)("span", { className: "wc-block-components-checkbox__label" }, n),
                        a
                    )
                );
            },
            re = oe;
        n(150);
        const ae = ({ className: t, onChange: n, options: o = [], checked: r = [], isLoading: i = !1, isDisabled: s = !1, limit: l = 10 }) => {
            const [c, u] = (0, a.useState)(!1),
                d = (0, a.useMemo)(() => [...Array(5)].map((t, n) => (0, e.createElement)("li", { key: n, style: { width: Math.floor(75 * Math.random()) + 25 + "%" } }, "Â ")), []),
                p = (0, a.useMemo)(() => {
                    const t = o.length - l;
                    return (
                        !c &&
                        (0, e.createElement)(
                            ...
                            (0, e.createElement)(
                                "button",
                                {
                                    ...
                                    "aria-expanded": !1,
                                    "aria-label": (0, h.sprintf) /* translators: %s is referring the remaining count of options */(
                                        /* translators: %s is referring the remaining count of options */
                                        (0, h._n)("Show %s more option", "Show %s more options", t, "woocommerce"),
                                        t
                                    ),
                                },
                                (0, h.sprintf) /* translators: %s number of options to reveal. */(/* translators: %s number of options to reveal. */ (0, h._n)("Show %s more", "Show %s more", t, "woocommerce"), t)
                            )
                        )
                    );
                }, [o, l, c]),
                ...
                g = Q()("wc-block-checkbox-list", "wc-block-components-checkbox-list", { "is-loading": i }, t);
            return (0, e.createElement)("ul", { className: g }, i ? d : f);
        };
        n(562);
        const ie = ({ text: t, screenReaderText: n = "", element: o = "li", className: r = "", radius: a = "small", children: i = null, ...s }) => {
                const l = o,
                ...
                return (0, e.createElement)(
                    l,
                    { className: c, ...s },
                    (0, e.createElement)("span", { "aria-hidden": u, className: "wc-block-components-chip__text" }, t),
                    u && (0, e.createElement)("span", { className: "screen-reader-text" }, n),
                    i
                );
            },
            se = (0, a.forwardRef)(function ({ icon: e, size: t = 24, ...n }, o) {
                return (0, a.cloneElement)(e, { width: t, height: t, ...n, ref: o });
            }),
            le = (0, e.createElement)(
                m.SVG,
                { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" },
                (0, e.createElement)(m.Path, { d: "M12 13.06l3.712 3.713 1.061-1.06L13.061 12l3.712-3.712-1.06-1.06L12 10.938 8.288 7.227l-1.061 1.06L10.939 12l-3.712 3.712 1.06 1.061L12 13.061z" })
            ),
            ce = ({ ariaLabel: t = "", className: n = "", disabled: o = !1, onRemove: r = () => {}, removeOnAnyClick: a = !1, text: i, screenReaderText: s = "", ...l }) => {
                const c = a ? "span" : "button";
                if (!t) {
                    const e = s && "string" == typeof s ? s : i;
                    t =
                        "string" != typeof e /* translators: Remove chip. */ /* translators: Remove chip. */
                            ? (0, h.__)("Remove", "woocommerce")
                            : (0, h.sprintf) /* translators: %s text of the chip to remove. */(/* translators: %s text of the chip to remove. */ (0, h.__)('Remove "%s"', "woocommerce"), e);
                }
                const u = {
                        "aria-label": t,
                        disabled: o,
                ...
                return (0, e.createElement)(
                    ie,
                    { ...l, ...d, className: Q()(n, "is-removable"), element: a ? "button" : l.element, screenReaderText: s, text: i },
                    (0, e.createElement)(c, { className: "wc-block-components-chip__remove", ...p }, (0, e.createElement)(se, { className: "wc-block-components-chip__remove-icon", icon: le, size: 16, role: "img" }))
                );
            };
        n(729), n(406);
        const ue = ({ children: t, className: n = "", headingLevel: o, ...r }) => {
                const a = Q()("wc-block-components-title", n),
                    i = `h${o}`;
                return (0, e.createElement)(i, { className: a, ...r }, t);
            },
            de = ({ title: t, stepHeadingContent: n }) =>
                (0, e.createElement)(
                    "div",
                    { className: "wc-block-components-checkout-step__heading" },
                    (0, e.createElement)(ue, { "aria-hidden": "true", className: "wc-block-components-checkout-step__title", headingLevel: "2" }, t),
                    !!n && (0, e.createElement)("span", { className: "wc-block-components-checkout-step__heading-content" }, n)
                ),
            pe = ({ id: t, className: n, title: o, legend: r, description: a, children: i, disabled: s = !1, showStepNumber: l = !0, stepHeadingContent: c = () => {} }) => {
                const u = r || o ? "fieldset" : "div";
                return (0, e.createElement)(
                    u,
                    { className: Q()(n, "wc-block-components-checkout-step", { "wc-block-components-checkout-step--with-step-number": l, "wc-block-components-checkout-step--disabled": s }), id: t, disabled: s },
                    !(!r && !o) && (0, e.createElement)("legend", { className: "screen-reader-text" }, r || o),
                    !!o && (0, e.createElement)(de, { title: o, stepHeadingContent: c() }),
                    (0, e.createElement)(
                        "div",
                        { className: "wc-block-components-checkout-step__container" },
                        !!a && (0, e.createElement)("p", { className: "wc-block-components-checkout-step__description" }, a),
                        (0, e.createElement)("div", { className: "wc-block-components-checkout-step__content" }, i)
                    )
                );
            };
        function me() {}
        ...
        function ve(e, t) {
            ...
            var n = "-" === e[0],
                o = n && t,
                r = (e = e.replace("-", "")).split(".");
            return { beforeDecimal: r[0], afterDecimal: r[1] || "", hasNagation: n, addNegation: o };
        }
        function ye(e, t, n) {
            ...
            Se = (function (e) {
                ...
                return (
                    ...
                    (n.prototype.updateValueIfRequired = function (e) {
                        ...
                        if ((void 0 === i && (i = ""), e !== n)) {
                            ...
                            var s = this.formatNumString(i),
                                ...
                                u = parseFloat(c),
                                d = parseFloat(i);
                            (((isNaN(u) && isNaN(d)) || u === d) && s === a && (null !== r || l === a)) || this.updateValue({ formattedValue: l, numAsString: c, input: r, source: "prop", event: null });
                        }
                    }),
                    ...
                    (n.prototype.getSeparators = function () {
                        ...
                        return !0 === n && (n = ","), o || (o = [e, "."]), { decimalSeparator: e, thousandSeparator: n, allowedDecimalSeparators: o };
                    }),
                    ...
                    (n.prototype.removeFormatting = function (e) {
                        ...
                        return e
                            ? (n
                                  ? (e = "string" == typeof n ? this.removePatternFormatting(e) : "function" == typeof o ? o(e) : (e.match(this.getNumberRegex(!0)) || []).join(""))
                    ...
                    (n.prototype.updateValue = function (e) {
                        ...
                        void 0 === i && (i = this.removeFormatting(t)), t !== c && (this.setState({ value: t, numAsString: i }), l(this.getValueObject(t, i), { event: a, source: r }));
                    }),
                    (n.prototype.onChange = function (e) {
                        ...
                        u || (l = i), this.updateValue({ formattedValue: l, numAsString: c, inputValue: n, input: t, event: e, source: "event" }), u && r.onChange(e);
                    }),
                    (n.prototype.onBlur = function (e) {
                        ...
                        if (((this.focusedElm = null), clearTimeout(this.focusTimeout), clearTimeout(this.caretPositionTimeout), !o)) {
                            ...
                            if (l !== s) return this.updateValue({ formattedValue: l, numAsString: i, input: e.target, setCaretPosition: !1, event: e, source: "event" }), void r(e);
                        }
                        r(e);
                    }),
                    (n.prototype.onKeyDown = function (e) {
                        ...
                        var s = this.props,
                            ...
                            v = "string" == typeof p;
                        if (
                            ((this.selectionBeforeInput = { selectionStart: r, selectionEnd: a }), "ArrowLeft" === o || "Backspace" === o ? (t = r - 1) : "ArrowRight" === o ? (t = r + 1) : "Delete" === o && (t = r), void 0 !== t && r === a)
                        ) {
                            var y = t,
                            ...
                            if ("ArrowLeft" === o || "ArrowRight" === o) {
                                ...
                                if ("Backspace" === o && !h.test(i[t]))
                                    if (r <= C + 1 && "-" === i[0] && void 0 === p) {
                                        var w = i.substring(1);
                                        this.updateValue({ formattedValue: w, caretPos: y, input: n, event: e, source: "event" });
                                    } else if (!g.test(i[t])) {
                                        for (; !h.test(i[y - 1]) && y > C; ) y--;
                                        y = this.correctCaretPosition(i, y, "left");
                                    }
                            } else for (; !h.test(i[y]) && y < E; ) y++;
                        ...
                        var e = this.props,
                            ...
                            d =
                                ...
                                (function (e) {
                                    ...
                                    ? "numeric"
                                    : void 0,
                            p = Object.assign({ inputMode: d }, l, { type: n, value: u, onChange: this.onChange, onKeyDown: this.onKeyDown, onMouseUp: this.onMouseUp, onFocus: this.onFocus, onBlur: this.onBlur });
                        if ("text" === o) return a ? a(u, l) || null : t().createElement("span", Object.assign({}, l, { ref: i }), u);
                        if (r) {
                            var m = r;
                            return t().createElement(m, Object.assign({}, p, { ref: i }));
                        }
                        return t().createElement("input", Object.assign({}, p, { ref: i }));
                    }),
                    n
                );
            })(t().Component);
        ...
        const Ae = (e) => ({
            ...
            Te = ({ className: t, value: n, currency: o, onValueChange: r, displayType: a = "text", ...i }) => {
                var s;
                ...
                const u = Q()("wc-block-formatted-money-amount", "wc-block-components-formatted-money-amount", t),
                    ...
                    p = { ...i, ...Ae(o), decimalScale: d, value: void 0, currency: void 0, onValueChange: void 0 },
                    m = r
                        ? (e) => {
                        ...
                        : () => {};
                return (0, e.createElement)(xe, { className: u, displayType: a, ...p, value: c, onValueChange: m });
            },
            ke = ({ label: t, screenReaderLabel: n, wrapperElement: o, wrapperProps: r = {} }) => {
                let i;
                const s = null != t,
                    l = null != n;
                return !s && l
                    ? ((i = o || "span"), (r = { ...r, className: Q()(r.className, "screen-reader-text") }), (0, e.createElement)(i, { ...r }, n))
                    : ((i = o || a.Fragment),
                      s && l && t !== n
                          ? (0, e.createElement)(i, { ...r }, (0, e.createElement)("span", { "aria-hidden": "true" }, t), (0, e.createElement)("span", { className: "screen-reader-text" }, n))
                          : (0, e.createElement)(i, { ...r }, t));
            },
            _e = (0, e.createElement)(m.SVG, { viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, (0, e.createElement)(m.Path, { d: "M6.5 12.4L12 8l5.5 4.4-.9 1.2L12 10l-4.5 3.6-1-1.2z" })),
            Re = (0, e.createElement)(m.SVG, { viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, (0, e.createElement)(m.Path, { d: "M17.5 11.6L12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z" }));
        n(847);
        const Me = ({ children: t, className: n, initialOpen: o = !1, hasBorder: r = !1, title: i, titleTag: s = "div" }) => {
                const [l, c] = (0, a.useState)(o);
                return (0, e.createElement)(
                    "div",
                    { className: Q()(n, "wc-block-components-panel", { "has-border": r }) },
                    (0, e.createElement)(
                        s,
                        null,
                        (0, e.createElement)(
                            "button",
                            { "aria-expanded": l, className: "wc-block-components-panel__button", onClick: () => c(!l) },
                            (0, e.createElement)(se, { "aria-hidden": "true", className: "wc-block-components-panel__button-icon", icon: l ? _e : Re }),
                            i
                        )
                    ),
                    l && (0, e.createElement)("div", { className: "wc-block-components-panel__content" }, t)
                );
            },
            Le = ({ label: t, secondaryLabel: n, description: o, secondaryDescription: r, id: a }) =>
                (0, e.createElement)(
                    "div",
                    ...
                    (0, e.createElement)(
                        ...
                        t && (0, e.createElement)("span", { id: a && `${a}__label`, className: "wc-block-components-radio-control__label" }, t),
                        n && (0, e.createElement)("span", { id: a && `${a}__secondary-label`, className: "wc-block-components-radio-control__secondary-label" }, n)
                    ),
                    (o || r) &&
                        (0, e.createElement)(
                            "div",
                            { className: "wc-block-components-radio-control__description-group" },
                            o && (0, e.createElement)("span", { id: a && `${a}__description`, className: "wc-block-components-radio-control__description" }, o),
                            r && (0, e.createElement)("span", { id: a && `${a}__secondary-description`, className: "wc-block-components-radio-control__secondary-description" }, r)
                        )
                ),
            Oe = ({ checked: t, name: n, onChange: o, option: r, disabled: a = !1 }) => {
                const { value: i, label: s, description: l, secondaryLabel: c, secondaryDescription: u } = r;
                return (0, e.createElement)(
                    "label",
                    { className: Q()("wc-block-components-radio-control__option", { "wc-block-components-radio-control__option-checked": t }), htmlFor: `${n}-${i}` },
                    (0, e.createElement)("input", {
                        ...
                        checked: t,
                        "aria-describedby": Q()({ [`${n}-${i}__label`]: s, [`${n}-${i}__secondary-label`]: c, [`${n}-${i}__description`]: l, [`${n}-${i}__secondary-description`]: u }),
                        disabled: a,
                    }),
                    (0, e.createElement)(Le, { id: `${n}-${i}`, label: s, secondaryLabel: c, description: l, secondaryDescription: u })
                );
            };
        n(803);
        const De = ({ className: t = "", id: n, selected: o = "", onChange: r, options: a = [], disabled: i = !1 }) => {
            ...
            $e = De,
            Ie = (0, d.withInstanceId)(({ className: t, instanceId: n, id: o, selected: r, onChange: a, options: i = [] }) => {
                const s = o || n;
                return i.length
                    ? (0, e.createElement)(
                          "div",
                          ...
                          i.map((t) => {
                              ...
                              return (0, e.createElement)(
                                  "div",
                                  { className: "wc-block-components-radio-control-accordion-option", key: t.value },
                                  (0, e.createElement)(Oe, {
                                  ...
                                  n && o && (0, e.createElement)("div", { className: Q()("wc-block-components-radio-control-accordion-content", { "wc-block-components-radio-control-accordion-content-hide": !o }) }, t.content)
                              );
                          })
                      )
                    : null;
        ...
        n(43);
        const Pe = (0, d.withInstanceId)(({ className: t, instanceId: n, label: o = "", onChange: r, options: a, screenReaderLabel: i, value: s = "", readOnly: l = !1 }) => {
                const c = `wc-block-components-sort-select__select-${n}`;
                return (0, e.createElement)(
                    "div",
                    { className: Q()("wc-block-sort-select", "wc-block-components-sort-select", t) },
                    (0, e.createElement)(ke, { label: o, screenReaderLabel: i, wrapperElement: "label", wrapperProps: { className: "wc-block-sort-select__label wc-block-components-sort-select__label", htmlFor: c } }),
                    (0, e.createElement)(
                        "select",
                        { disabled: !!l, id: c, className: "wc-block-sort-select__select wc-block-components-sort-select__select", onChange: r, value: s },
                        a && a.map((t) => (0, e.createElement)("option", { key: t.key, value: t.key }, t.label))
                    )
                );
            }),
            Fe = (0, e.createElement)(m.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" }, (0, e.createElement)(m.Path, { d: "M13 11.8l6.1-6.3-1-1-6.1 6.2-6.1-6.2-1 1 6.1 6.3-6.5 6.7 1 1 6.5-6.6 6.5 6.6 1-1z" }));
        n(946);
        const Be = (0, e.createElement)(m.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" }, (0, e.createElement)(m.Path, { d: "M16.7 7.1l-6.3 8.5-3.3-2.5-.9 1.2 4.5 3.4L17.9 8z" })),
            He = (0, e.createElement)(
                m.SVG,
                { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" },
            ...
            Ze = window.wp.a11y,
            Ke = ({ className: t, status: n = "default", children: o, spokenMessage: r = o, onRemove: i = () => {}, isDismissible: s = !0, politeness: l = Ue(n), summary: c }) => (
                ((e, t) => {
                ...
                (0, e.createElement)(
                    "div",
                    { className: Q()(t, "wc-block-components-notice-banner", "is-" + n, { "is-dismissible": s }) },
                    (0, e.createElement)(se, { icon: Ge(n) }),
                    (0, e.createElement)("div", { className: "wc-block-components-notice-banner__content" }, c && (0, e.createElement)("p", { className: "wc-block-components-notice-banner__summary" }, c), o),
                    !!s &&
            ...
            je = ({ className: t, children: n, status: o, ...r }) => (0, e.createElement)(Ke, { className: Q()("wc-block-store-notice", t), status: o, ...r }, n),
            We = window.wp.data,
        ...
        const qe = ["a", "b", "em", "i", "strong", "p", "br"],
            ...
            et = (e, t) => {
                ...
                return Xe().sanitize(e, { ALLOWED_TAGS: n, ALLOWED_ATTR: o });
            };
        function tt(e, t) {
            const n = (0, a.useRef)();
            return (
        ...
        const nt = window.wp.htmlEntities,
            ot = ({ className: t, notices: n }) => {
                const o = (0, a.useRef)(null),
                    { removeNotice: r } = (0, We.useDispatch)("core/notices"),
                    i = n.map((e) => e.id),
                    s = tt(i);
                (0, a.useEffect)(() => {
                    const e = o.current;
                    ...
                    (t && -1 !== ["input", "select", "button", "textarea"].indexOf(t.tagName.toLowerCase()) && "radio" !== t.getAttribute("type")) ||
                        (i.filter((e) => !s || !s.includes(e)).length && null != e && e.scrollIntoView && e.scrollIntoView({ behavior: "smooth" }));
                }, [i, s, o]);
                const l = n.filter(({ isDismissible: e }) => !!e),
                    c = n.filter(({ isDismissible: e }) => !e),
                    u = {
                        error: l.filter(({ status: e }) => "error" === e),
                        success: l.filter(({ status: e }) => "success" === e),
                        warning: l.filter(({ status: e }) => "warning" === e),
                        info: l.filter(({ status: e }) => "info" === e),
                        default: l.filter(({ status: e }) => "default" === e),
                    };
                return (0, e.createElement)(
                    "div",
                    { ref: o, className: Q()(t, "wc-block-components-notices") },
                    c.map((t) => (0, e.createElement)(je, { key: t.id + "-" + t.context, ...t }, (0, e.createElement)(a.RawHTML, null, et((0, nt.decodeEntities)(t.content))))),
                    Object.entries(u).map(([t, n]) => {
                        if (!n.length) return null;
                        const o = n.filter((e, t, n) => n.findIndex((t) => t.content === e.content) === t).map((e) => ({ ...e, content: et((0, nt.decodeEntities)(e.content)) })),
                            i = {
                                key: `store-notice-${t}`,
                                status: t,
                                onRemove: () => {
                        ...
                        return 1 === o.length
                            ? (0, e.createElement)(je, { ...i }, (0, e.createElement)(a.RawHTML, null, n[0].content))
                            : (0, e.createElement)(
                                  je,
                                  { ...i, summary: "error" === t ? (0, h.__)("Please fix the following errors before continuing", "woocommerce") : "" },
                                  (0, e.createElement)(
                                      "ul",
                                      null,
                                      o.map((t) => (0, e.createElement)("li", { key: t.id + "-" + t.context }, (0, e.createElement)(a.RawHTML, null, t.content)))
                                  )
                              );
                    })
                );
            ...
            return (
                Object.keys(a).forEach(function (i) {
                    ...
                    if ((0, e.isValidElement)(s)) {
                        ...
                        !c || (l && !d)
                            ? c || !l || d
                                ? c && l && (0, e.isValidElement)(u) && (a[i] = (0, e.cloneElement)(s, { onExited: o.bind(null, s), in: u.props.in, exit: ct(s, "exit", t), enter: ct(s, "enter", t) }))
                                : (a[i] = (0, e.cloneElement)(s, { in: !1 }))
                            : (a[i] = (0, e.cloneElement)(s, { onExited: o.bind(null, s), in: !0, exit: ct(s, "exit", t), enter: ct(s, "enter", t) }));
                    }
                }),
                a
            );
        ...
        var dt =
            ...
            pt = (function (n) {
                function o(e, t) {
                    var o,
                        r = (o = n.call(this, e, t) || this).handleExited.bind(
                            (function (e) {
                                if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                                return e;
                            })(o)
                        );
                    return (o.state = { contextValue: { isMounting: !0 }, handleExited: r, firstRender: !0 }), o;
                }
                it(o, n);
                var a = o.prototype;
                return (
                    ...
                    (o.getDerivedStateFromProps = function (t, n) {
                        ...
                        return {
                            children: n.firstRender
                                ? ((o = t),
                                  (r = i),
                                  lt(o.children, function (t) {
                                      return (0, e.cloneElement)(t, { onExited: r.bind(null, t), in: !0, appear: ct(t, "appear", o), enter: ct(t, "enter", o), exit: ct(t, "exit", o) });
                                  }))
                                : ut(t, a, i),
                            firstRender: !1,
                        };
                    ...
                    (a.render = function () {
                        ...
                        return delete r.appear, delete r.enter, delete r.exit, null === n ? t().createElement(st.Provider, { value: a }, i) : t().createElement(st.Provider, { value: a }, t().createElement(n, r, i));
                    }),
                    o
                );
            })(t().Component);
        ...
        var vt = function (e) {
            ...
            Nt = (function (e) {
                function n(t, n) {
                    ...
                    return (o.appearStatus = null), t.in ? (a ? ((r = Ct), (o.appearStatus = Et)) : (r = bt)) : (r = t.unmountOnExit || t.mountOnEnter ? yt : Ct), (o.state = { status: r }), (o.nextCallback = null), o;
                }
                it(n, e),
                    (n.getDerivedStateFromProps = function (e, t) {
                        return e.in && t.status === yt ? { status: Ct } : null;
                    });
                var o = n.prototype;
                return (
                    ...
                    (o.updateStatus = function (e, t) {
                        ...
                        else this.props.unmountOnExit && this.state.status === Ct && this.setState({ status: yt });
                    }),
                              ...
                              this.safeSetState({ status: Et }, function () {
                                  t.props.onEntering(a, i),
                                      t.onTransitionEnd(l, function () {
                                          t.safeSetState({ status: bt }, function () {
                    ...
                    (o.render = function () {
                        ...
                        var n = this.props,
                            ...
                            r =
                                ...
                                n.onExited,
                                n.nodeRef,
                                rt(n, ["children", "in", "mountOnEnter", "unmountOnExit", "appear", "enter", "exit", "timeout", "addEndListener", "onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "nodeRef"]));
                        return t().createElement(st.Provider, { value: null }, "function" == typeof o ? o(e, r) : t().cloneElement(t().Children.only(o), r));
                    }),
                    n
                );
            })(t().Component);
        ...
        (Nt.contextType = st),
            (Nt.propTypes = {}),
            (Nt.defaultProps = { in: !1, mountOnEnter: !1, unmountOnExit: !1, appear: !1, enter: !0, exit: !0, onEnter: St, onEntering: St, onEntered: St, onExit: St, onExiting: St, onExited: St }),
            (Nt.UNMOUNTED = yt),
            (Nt.EXITED = Ct),
            (Nt.ENTERING = Et),
            (Nt.ENTERED = bt),
        ...
        var At = function (e, t) {
            ...
            Tt = (function (e) {
                function n() {
                    ...
                    return (
                        ((t = e.call.apply(e, [this].concat(o)) || this).appliedClasses = { appear: {}, enter: {}, exit: {} }),
                        ...
                        (t.getClassNames = function (e) {
                            var n = t.props.classNames,
                                o = "string" == typeof n,
                                r = o ? (o && n ? n + "-" : "") + e : n[e];
                            return { baseClassName: r, activeClassName: o ? r + "-active" : n[e + "Active"], doneClassName: o ? r + "-done" : n[e + "Done"] };
                        }),
                        t
                    );
                }
                ...
                return (
                    ...
                    (o.render = function () {
                        ...
                        return t().createElement(xt, r({}, n, { onEnter: this.onEnter, onEntered: this.onEntered, onEntering: this.onEntering, onExit: this.onExit, onExiting: this.onExiting, onExited: this.onExited }));
                    }),
                    n
                );
            })(t().Component);
        (Tt.defaultProps = { classNames: "" }), (Tt.propTypes = {});
        const kt = Tt;
        n(194);
        const _t = ({ onRemove: t = () => {}, children: n, listRef: o, className: r, ...i }) => (
                (0, a.useEffect)(() => {
                    const e = setTimeout(() => {
                        t();
                    }, 1e4);
            ...
            Rt = ({ notices: t, className: n, onRemove: o = () => {} }) => {
                const r = (0, a.useRef)(null),
                    i = (0, d.useReducedMotion)(),
                    s = (e) => () => o((null == e ? void 0 : e.id) || "");
                return (0, e.createElement)(
                    "div",
                    { className: Q()(n, "wc-block-components-notice-snackbar-list"), tabIndex: -1, ref: r },
                    i
                        ? t.map((t) => {
                              const { content: n, ...o } = t;
                              return (0, e.createElement)(_t, { ...o, onRemove: s(t), listRef: r, key: t.id }, t.content);
                          })
                        : (0, e.createElement)(
                              mt,
                              null,
                              t.map((t) => {
                                  const { content: n, ...o } = t;
                                  return (0, e.createElement)(kt, { key: "snackbar-" + t.id, timeout: 500, classNames: "notice-transition" }, (0, e.createElement)(_t, { ...o, onRemove: s(t), listRef: r }, n));
                              })
                          )
                );
            },
            Mt = ({ className: t, notices: n }) => {
                const { removeNotice: o } = (0, We.useDispatch)("core/notices");
            ...
            Lt = (e, t) => e.map((e) => ({ ...e, context: t })),
            Ot = ({ className: t = "", context: n = "", additionalNotices: o = [] }) => {
                const { registerContainer: r, unregisterContainer: i } = (0, We.useDispatch)(ze.STORE_NOTICES_STORE_KEY),
                    { suppressNotices: s, registeredContainers: l } = (0, We.useSelect)((e) => ({
                    ...
                    c = (0, a.useMemo)(() => (Array.isArray(n) ? n : [n]), [n]),
                    u = Object.values(Ye).filter((e) => c.some((t) => e.includes(t + "/")) && !l.includes(e)),
                    d = (0, We.useSelect)((e) => {
                ...
                return (
                    ...
                    s
                        ...
                        : (0, e.createElement)(
                              e.Fragment,
                              null,
                              (0, e.createElement)(ot, { className: t, notices: d.filter((e) => "default" === e.type) }),
                              (0, e.createElement)(Mt, { className: t, notices: d.filter((e) => "snackbar" === e.type) })
                          )
                );
            };
        n(203);
        const Dt = ({ className: t = "", disabled: n = !1, onTextChange: o, placeholder: r, value: a = "" }) =>
        ...
        const $t = (0, a.forwardRef)(
            (
                ...
                return (0, e.createElement)(
                    "div",
                    { className: Q()("wc-block-components-text-input", t, { "is-active": E || m }) },
                    (0, e.createElement)("input", {
                        type: o,
                        id: n,
                    ...
                    (0, e.createElement)(ke, { label: s, screenReaderLabel: l || s, wrapperElement: "label", wrapperProps: { htmlFor: n }, htmlFor: n }),
                    !!u && (0, e.createElement)("p", { id: n + "__help", className: "wc-block-components-text-input__help" }, u),
                    v
                );
            }
        );
        n(785);
        const It = ({ errorMessage: t = "", propertyName: n = "", elementId: o = "" }) => {
                const { validationError: r, validationErrorId: a } = (0, We.useSelect)((e) => {
                    const t = e(ze.VALIDATION_STORE_KEY);
                    return { validationError: t.getValidationError(n), validationErrorId: t.getValidationErrorId(o) };
                });
                if (!t || "string" != typeof t) {
                    if (null == r || !r.message || (null != r && r.hidden)) return null;
                    t = r.message;
                }
                return (0, e.createElement)("div", { className: "wc-block-components-validation-error", role: "alert" }, (0, e.createElement)("p", { id: a }, t));
            },
            Pt = It,
            Ft = (e, t) => {
                const { valid: n, customError: o, valueMissing: r, badInput: a, typeMismatch: i } = t.validity;
                if (n || o) return t.validationMessage;
                const s = (0, h.sprintf) /* translators: %s field label */(/* translators: %s field label */ (0, h.__)("Please enter a valid %s", "woocommerce"), e.toLowerCase());
        ...
        const Ht = new Map([
            ...
            Vt =
                ...
                (0, a.forwardRef)(
                    (
                        ...
                        const [E, b] = (0, a.useState)(!0),
                            w = tt(p),
                            N = (0, a.useRef)(null),
                            S = (0, d.useInstanceId)(Vt, "", v),
                            x = void 0 !== n ? n : "textinput-" + S,
                            A = void 0 !== i ? i : x,
                            { setValidationErrors: T, hideValidationError: k, clearValidationError: _ } = (0, We.useDispatch)(ze.VALIDATION_STORE_KEY),
                            R = (0, a.useRef)(m);
                        (0, a.useEffect)(() => {
                            R.current = m;
                        }, [m]);
                        const { validationError: M, validationErrorId: L } = (0, We.useSelect)((e) => {
                                const t = e(ze.VALIDATION_STORE_KEY);
                            ...
                            O = (0, a.useCallback)(
                                (e = !0) => {
                                    ...
                                    null !== t && ((t.value = t.value.trim()), t.setCustomValidity(""), t.checkValidity() && R.current(t) ? _(A) : T({ [A]: { message: h ? Ft(h, t) : t.validationMessage, hidden: e } }));
                                },
                                [_, A, T, h]
                            );
                        var D;
                        (0, a.useImperativeHandle)(
                            ...
                            "" !== u && !((e) => null === e)((D = M)) && D instanceof Object && D.constructor === Object && (M.message = u);
                        const $ = (null == M ? void 0 : M.message) && !(null != M && M.hidden),
                            I = c && $ && L ? L : r;
                        return (0, e.createElement)($t, {
                            className: Q()(t, { "has-error": $ }),
                            "aria-invalid": !0 === $,
                            id: x,
                            type: o,
                            feedback: c ? (0, e.createElement)(It, { errorMessage: u, propertyName: A }) : null,
                            ref: N,
                            onChange: (e) => {
                                k(A), O(!0);
                                const t = f(e);
            ...
            Ut = Vt;
        n(658);
        const Gt = ({ value: t, currency: n }) =>
                (0, a.isValidElement)(t)
                    ? (0, e.createElement)("div", { className: "wc-block-components-totals-item__value" }, t)
                    : Number.isFinite(t)
                    ? (0, e.createElement)(Te, { className: "wc-block-components-totals-item__value", currency: n || {}, value: t })
                    : null,
            Zt = ({ className: t, currency: n, label: o, value: r, description: a }) =>
                (0, e.createElement)(
                    "div",
                    { className: Q()("wc-block-components-totals-item", t) },
                    (0, e.createElement)("span", { className: "wc-block-components-totals-item__label" }, o),
                    (0, e.createElement)(Gt, { value: r, currency: n }),
                    (0, e.createElement)("div", { className: "wc-block-components-totals-item__description" }, a)
                ),
            Kt = window.wc.wcSettings,
            jt = ({ currency: t, values: n, className: o }) => {
                const { total_items: r, total_items_tax: a } = n,
                    i = parseInt(r, 10),
                    s = parseInt(a, 10);
                return (0, e.createElement)(Zt, { className: o, currency: t, label: (0, h.__)("Subtotal", "woocommerce"), value: (0, Kt.getSetting)("displayCartPricesIncludingTax", !1) ? i + s : i });
            },
            Wt = ({ currency: t, values: n, className: o, showRateAfterTaxName: r }) => {
                const { total_tax: a, tax_lines: i } = n;
                    ...
                    l =
                        s && i.length > 0
                            ? (0, e.createElement)(
                                  e.Fragment,
                                  null,
                                  i.map(({ name: n, rate: a, price: i }, s) => {
                                      const l = `${n}${r ? ` ${a}` : ""}`;
                                      return (0, e.createElement)(Zt, { key: `tax-line-${s}`, className: Q()("wc-block-components-totals-taxes", o), currency: t, label: l, value: parseInt(i, 10) });
                                  }),
                                  " "
                              )
                            : null;
                return s
                    ...
                    : (0, e.createElement)(
                          e.Fragment,
                          null,
                          (0, e.createElement)(Zt, { className: Q()("wc-block-components-totals-taxes", o), currency: t, label: (0, h.__)("Taxes", "woocommerce"), value: parseInt(a, 10), description: null })
                      );
            },
            zt = ({ currency: t, cartFees: n, className: o }) =>
                (0, e.createElement)(
                    e.Fragment,
                    null,
                    n.map(({ id: n, key: r, name: a, totals: i }, s) => {
        ...
        n(878);
        const Yt = ({ children: t, slotWrapper: n = !1, className: o }) => (a.Children.count(t) ? (0, e.createElement)("div", { className: Q()(o, "wc-block-components-totals-wrapper", { "slot-wrapper": n }) }, t) : null);
    })(),
