    ...
    [354],
    {
        ...
        6752: (e, t, n) => {
            ...
            class NestedTitleKeyboardHandler extends s.default {
                ...
                getDefaultSettings() {
                    return {
                        selectors: { itemTitle: `[id*="e-n-tab-title-${this.getWidgetNumber()}"]`, itemContainer: `[id*="e-n-tab-content-${this.getWidgetNumber()}"]` },
            ...
            class CarouselHandlerBase extends s.default {
                ...
                getSwiperSettings() {
                    const e = this.getElementSettings(),
                        ...
                        r = { slidesPerView: t, loop: "yes" === e.infinite, speed: e.speed, handleElementorBreakpoints: !0, breakpoints: {} };
                    let o = t;
                    Object.keys(i)
                        .reverse()
                        .forEach((t) => {
                            const n = s[t] ? s[t] : o;
                            (r.breakpoints[i[t].value] = { slidesPerView: +e["slides_to_show_" + t] || n, slidesPerGroup: +e["slides_to_scroll_" + t] || 1 }),
                                e.image_spacing_custom && (r.breakpoints[i[t].value].spaceBetween = this.getSpaceBetween(t)),
                                (o = +e["slides_to_show_" + t] || n);
                        }),
                        "yes" === e.autoplay && (r.autoplay = { delay: e.autoplay_speed, disableOnInteraction: "yes" === e.pause_on_interaction }),
                        n ? ((r.effect = e.effect), "fade" === e.effect && (r.fadeEffect = { crossFade: !0 })) : (r.slidesPerGroup = +e.slides_to_scroll || 1),
                    ...
                    return (
                        a && (r.navigation = { prevEl: ".elementor-swiper-button-prev", nextEl: ".elementor-swiper-button-next" }),
                        l &&
                            (r.pagination = {
                        ...
                        "yes" === e.lazyload && (r.lazy = { loadPrevNext: !0, loadPrevNextAmount: 1 }),
                        (r.a11y = {
                            enabled: !0,
            ...
            t.default = class Scroll {
                static scrollObserver(e) {
                    ...
                    return new IntersectionObserver(function handleIntersect(n) {
                        ...
                        e.callback({ sensitivity: e.sensitivity, isInViewport: s, scrollPercentage: o, intersectionScrollDirection: r }), (t = i);
                    }, n);
                }
        ...
        5955: (e, t, n) => {
            ...
            var s = i(n(1192)),
                ...
                l = i(n(400)),
                c = i(n(869)),
                u = (window.elementorModules = { Module: s.default, ViewModule: r.default, ArgsObject: o.default, ForceMethodImplementation: c.default, utils: { Masonry: a.default, Scroll: l.default } });
            t.default = u;
        },
        1519: (e, t, n) => {
            "use strict";
            ...
            class ContactButtonsHandler extends r.default {
                ...
                bindEvents() {
                    this.elements.closeButton && this.elements.closeButton.addEventListener("click", this.closeChatBox.bind(this)),
                        this.elements.chatButton &&
                            (this.elements.chatButton.addEventListener("click", this.onChatButtonClick.bind(this)), this.elements.chatButton.addEventListener("animationend", this.removeChatButtonAnimationClasses.bind(this))),
                        this.elements.content && this.elements.content.addEventListener("animationend", this.removeAnimationClasses.bind(this)),
                        this.elements.contentWrapper && (this.elements.contentWrapper.addEventListener("click", this.onChatButtonTrackClick.bind(this)), window.addEventListener("keyup", this.onDocumentKeyup.bind(this))),
                ...
                contentWrapperIsHidden(e) {
                    ...
                    return !0 === e
                        ? (this.elements.contentWrapper.classList.add(t), void this.elements.contentWrapper.setAttribute("aria-hidden", "true"))
                        : !1 === e
                        ? (this.elements.contentWrapper.classList.remove(t), void this.elements.contentWrapper.setAttribute("aria-hidden", "false"))
                ...
                sendClicks() {
                    ...
                    e.append("action", "elementor_send_clicks"),
                        ...
                        fetch(elementorFrontendConfig?.urls?.ajaxurl, { method: "POST", body: e }).then(() => {
                            this.clicks = [];
                        });
                }
                removeAnimationClasses() {
                    ...
                    r
                        ? (this.elements.content.classList.remove(i), this.elements.content.classList.remove(e), a && this.elements.content.classList.remove(a), this.elements.content.classList.remove(s))
                        : (this.elements.content.classList.remove(i), o && this.elements.content.classList.remove(o), this.elements.content.classList.add(s));
                }
                ...
                chatBoxExitAnimation() {
                    ...
                    r &&
                        s !== r &&
                        (this.elements.content && (this.elements.content.classList.add(n), this.elements.content.classList.add(e), this.elements.content.classList.add(r)),
                ...
                openChatBox() {
                    ...
                    this.elements.main && this.elements.main.classList.contains(e) ? this.chatBoxEntranceAnimation() : this.elements.content && this.elements.content.classList.add(t),
                        this.elements.contentWrapper &&
                            (this.contentWrapperIsHidden(!1), elementorFrontend.isEditMode() || (this.elements.contentWrapper.setAttribute("tabindex", "0"), this.elements.contentWrapper.focus({ focusVisible: !0 }))),
                ...
                closeChatBox() {
                    ...
                    this.elements.main && this.elements.main.classList.contains(e) ? this.chatBoxExitAnimation() : this.elements.content && this.elements.content.classList.remove(t),
                        ...
                        this.elements.chatButton && (this.elements.chatButton.setAttribute("aria-expanded", "false"), this.elements.chatButton.focus({ focusVisible: !0 })),
                ...
                initMessageBubbleTime() {
                    ...
                    this.elements.messageBubbleTime.innerHTML = new Intl.DateTimeFormat("default", { hour12: e, hour: "numeric", minute: "numeric" }).format(new Date());
                }
        ...
        32: (e, t, n) => {
            ...
            class NestedAccordion extends s.default {
                ...
                injectKeyboardHandler() {
                    "nested-accordion.default" === this.getSettings("elementName") && new r.default({ $element: this.$element, toggleTitle: this.clickListener.bind(this) });
                }
                interlaceContainers() {
                ...
                animateItem(e, t, n, i) {
                    ...
                    s && s.cancel(),
                        (s = e.animate({ height: [t, n] }, { duration: this.getAnimationDuration() })),
        ...
        7323: (e, t, n) => {
            ...
            class NestedTabs extends s.default {
                ...
                getDefaultElements() {
                    const e = this.getSettings("selectors");
                    return { $widgetContainer: this.findElement(e.widgetContainer), $tabTitles: this.findElement(e.tabTitle), $tabContents: this.findElement(e.tabContent), $headingContainer: this.findElement(e.headingContainer) };
                }
                ...
                activateDefaultTab() {
                    ...
                    this.setSettings({ showTabFn: "show", hideTabFn: "hide" }), this.changeActiveTab(t), this.setSettings(n), this.elements.$widgetContainer.addClass("e-activated");
                }
                ...
                getHorizontalScrollingSettings() {
                    return { element: this.elements.$headingContainer[0], direction: this.getTabsDirection(), justifyCSSVariable: "--n-tabs-heading-justify-content", horizontalScrollStatus: this.getHorizontalScrollSetting() };
                }
            }
        ...
        1343: (e, t, n) => {
            ...
            e.exports = function (e, t, n, a) {
                ...
                if ((i(n) && r(n, c, a), a.global)) l ? (e[t] = n) : o(t, n);
                    ...
                    l ? (e[t] = n) : s.f(e, t, { value: n, enumerable: !1, configurable: !a.nonConfigurable, writable: !a.nonWritable });
                }
                return e;
            };
        },
            ...
            var i = n(8240),
                ...
                S = (e.exports = function (e, t, n) {
                    "Symbol(" === p(m(t), 0, 7) && (t = "[" + f(m(t), /^Symbol\(([^)]*)\)/, "$1") + "]"),
                        ...
                        v && n && o(n, "arity") && e.length !== n.arity && g(e, "length", { value: n.arity });
                    try {
                ...
                ? r
                    ? function defineProperty(e, t, n) {
                          if ((o(e), (t = a(t)), o(n), "function" == typeof e && "prototype" === t && "value" in n && m in n && !n[m])) {
                              var i = u(e, t);
                              i && i[m] && ((e[t] = n.value), (n = { configurable: h in n ? n[h] : i[h], enumerable: d in n ? n[d] : i[d], writable: !1 }));
                          }
                          return c(e, t, n);
                      }
                    : c
        ...
        1557: (e, t, n) => {
            ...
            e.exports = function (e, t, n, f) {
                ...
                if (w) {
                    ...
                    if (((x.prototype = E), "Error" !== S ? (a ? a(x, T) : l(x, T, { name: !0 })) : g && b in w && (c(x, w, b), c(x, w, "prepareStackTrace")), l(x, w), !p))
                        try {
