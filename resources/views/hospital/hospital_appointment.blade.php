                ...
                <div class="card-body">
                  <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                    <div class="mb-3 mb-sm-0">
                      <h5 class="card-title fw-semibold">Vaccination Overview</h5>
                    </div>
                    <div>
                    ...
                    <thead class="text-dark fs-4">
                      <tr>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">child_name</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">child_dob</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">parent_name</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">parent_email</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">parent_phone</h6>
                        </th>
<th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">vaccine_type</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <tbody>
                        @foreach( $hospitalAppointments as $a_details )
                      <tr>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->child_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->child_dob}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->parent_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->parent_email}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->parent_phone}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->vaccine_type}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->date}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->time}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->hospital_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->gender}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$a_details->child_allergies}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold"> <form action="{{ route('hospital.updateappointmentStatus', $a_details->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <select name="status" onchange="this.form.submit()">
                                <option value="pending" {{ $a_details->status == 'pending' ? 'selected' : '' }}>Pending</option>
                                <option value="approved" {{ $a_details->status == 'approved' ? 'selected' : '' }}>Approved</option>
                            </select>
                        </form></td>
                      </tr>
                      @endforeach
