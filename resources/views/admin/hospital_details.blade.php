              ...
              <div class=" p-4">
                ...
                <div class="">
                  <table class="table table-bordered table-striped text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        @foreach( $fetchhospital as $details )
                      <tr>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->hospitalname}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->hospitaladdress}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->hospitalnumber}}</td>
