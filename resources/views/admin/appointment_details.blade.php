...
<th class="border-bottom-0">
                    ...
                    <tbody>
                        @foreach( $appointment_details as $details )
                      <tr>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->child_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->child_dob}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->parent_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->parent_email}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->parent_phone}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->vaccine_type}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->date}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->time}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->hospital_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->gender}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->child_allergies}}</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
